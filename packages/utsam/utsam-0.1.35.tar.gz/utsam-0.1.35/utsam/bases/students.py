...
class StudentMarking:
    ...
    def to_json(self):
        ...
        json_file_name = f'{student_path}/{self.assignment.course_code}-{self.assignment.year}{self.assignment.semester}-{self.assignment.assignment}_{self.student_id}_{now.to_w3c_string()}.json'
