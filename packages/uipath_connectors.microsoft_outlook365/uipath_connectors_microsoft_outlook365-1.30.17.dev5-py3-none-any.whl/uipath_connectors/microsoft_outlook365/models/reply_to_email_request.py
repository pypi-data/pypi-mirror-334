...
from ..models.reply_to_email_request_message import ReplyToEmailRequestMessage


class ReplyToEmailRequest(BaseModel):
    """
    Attributes:
        message (Optional[ReplyToEmailRequestMessage]):
        comment (Optional[str]): The body of email Example: new comment.
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    message: Optional["ReplyToEmailRequestMessage"] = Field(
