...
class HusseinTool:
    ...
    def get_current_version(self):
        ...
        try:
            from importlib.metadata import version  # Use importlib.metadata instead
            return version("hussein")  # Get the package version
        except Exception:
            # Fallback to hardcoded version if package info is not available
