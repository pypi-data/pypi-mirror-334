...
from ..models.upload_file_response_shared_link_shared_link_access import (
    UploadFileResponseSharedLinkSharedLinkAccess,
)
from ..models.upload_file_response_shared_link_shared_link_effective_access import (
    UploadFileResponseSharedLinkSharedLinkEffectiveAccess,
)
from ..models.upload_file_response_shared_link_shared_link_effective_permission import (
    UploadFileResponseSharedLinkSharedLinkEffectivePermission,
)
import datetime
...
class UploadFileResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[UploadFileResponseSharedLinkSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[UploadFileResponseSharedLinkSharedLinkEffectiveAccess]): The effective access level
            for the shared link. This can be a more
            restrictive access level than the value in the `access` field when the
            enterprise settings restrict the allowed access levels.
        effective_permission (Optional[UploadFileResponseSharedLinkSharedLinkEffectivePermission]): The effective
    ...
    access: Optional[UploadFileResponseSharedLinkSharedLinkAccess] = Field(
