...
from ..models.search_shared_link_shared_link_access import (
    SearchSharedLinkSharedLinkAccess,
)
from ..models.search_shared_link_shared_link_effective_access import (
    SearchSharedLinkSharedLinkEffectiveAccess,
)
from ..models.search_shared_link_shared_link_effective_permission import (
    SearchSharedLinkSharedLinkEffectivePermission,
)
import datetime
...
class SearchSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[SearchSharedLinkSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[SearchSharedLinkSharedLinkEffectiveAccess]): The effective access level for the
            shared link. This can be a more
            restrictive access level than the value in the `access` field when the
            enterprise settings restrict the allowed access levels.
        effective_permission (Optional[SearchSharedLinkSharedLinkEffectivePermission]): The effective permissions for
            this shared link.
    ...
    access: Optional[SearchSharedLinkSharedLinkAccess] = Field(
    ...
    effective_access: Optional[SearchSharedLinkSharedLinkEffectiveAccess] = Field(
        alias="effective_access", default=None
    )
    effective_permission: Optional[SearchSharedLinkSharedLinkEffectivePermission] = (
