...
from ..models.cancel_sign_request_response_signers_inputs_array_item_ref_signers_inputs_type import (
    CancelSignRequestResponseSignersInputsArrayItemRefSignersInputsType,
)
import datetime
...
class CancelSignRequestResponseSignersInputsArrayItemRef(BaseModel):
    ...
    Attributes:
        ...
        type_ (Optional[CancelSignRequestResponseSignersInputsArrayItemRefSignersInputsType]): Type of input
    """
