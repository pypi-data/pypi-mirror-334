...
from ..models.list_sign_request_signers_array_item_ref_signers_role import (
    ListSignRequestSignersArrayItemRefSignersRole,
)
...
class ListSignRequestSignersArrayItemRef(BaseModel):
    ...
    Attributes:
        ...
        role (Optional[ListSignRequestSignersArrayItemRefSignersRole]): Defines the role of the signer in the sign
            request. A `signer`
    ...
    role: Optional[ListSignRequestSignersArrayItemRefSignersRole] = Field(
