...
from ..models.list_sign_request_source_files_array_item_ref_source_files_type import (
    ListSignRequestSourceFilesArrayItemRefSourceFilesType,
)
...
class ListSignRequestSourceFilesArrayItemRef(BaseModel):
    ...
    Attributes:
        ...
        type_ (Optional[ListSignRequestSourceFilesArrayItemRefSourceFilesType]): `file`
    """
    ...
    type_: Optional[ListSignRequestSourceFilesArrayItemRefSourceFilesType] = Field(
