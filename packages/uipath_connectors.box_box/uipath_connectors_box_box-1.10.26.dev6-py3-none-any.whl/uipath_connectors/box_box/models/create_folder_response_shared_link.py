...
from ..models.create_folder_response_shared_link_shared_link_access import (
    CreateFolderResponseSharedLinkSharedLinkAccess,
)
from ..models.create_folder_response_shared_link_shared_link_effective_access import (
    CreateFolderResponseSharedLinkSharedLinkEffectiveAccess,
)
from ..models.create_folder_response_shared_link_shared_link_effective_permission import (
    CreateFolderResponseSharedLinkSharedLinkEffectivePermission,
)
import datetime
...
class CreateFolderResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[CreateFolderResponseSharedLinkSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[CreateFolderResponseSharedLinkSharedLinkEffectiveAccess]): The effective access level
            for the shared link. This can be a more
            restrictive access level than the value in the `access` field when the
            enterprise settings restrict the allowed access levels.
        effective_permission (Optional[CreateFolderResponseSharedLinkSharedLinkEffectivePermission]): The effective
    ...
    access: Optional[CreateFolderResponseSharedLinkSharedLinkAccess] = Field(
