...
from autoflow.storage.tidb.types import TableModel
...
class SQLExecuteResult:
    def __init__(self, rowcount: int, success: bool, message: Optional[str] = None):
...
class TiDBClient:
    ...
    def execute(self, sql: str, params: Optional[dict] = None, raise_error: Optional[bool] = False) -> SQLExecuteResult:
    ...
    def query(self, sql: str, params: Optional[dict] = None, ) -> SQLQueryResult:
        with Session(self._db_engine) as session:
