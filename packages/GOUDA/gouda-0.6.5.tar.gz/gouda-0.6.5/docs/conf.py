...
try:
    from gouda import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "GOUDA Documentation", "Sean Mullan", "manual")
]
