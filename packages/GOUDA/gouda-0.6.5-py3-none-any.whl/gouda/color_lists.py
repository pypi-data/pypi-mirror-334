...
def find_color_hex(color_name: str, on_err: str = "raise") -> str | None:
    ...
    if color_name in html:
        return html[color_name]
    if color_name in crayons:
        return crayons[color_name]
    if color_name in xkcd_rgb:
        return xkcd_rgb[color_name]

    # Simple reformatting check
    if color_name.title().replace(" ", "") in html:
        return html[color_name.title().replace(" ", "")]
    if color_name.title() in crayons:
