...
class KexNistp256(object):
    ...
    def start_kex(self):
        ...
        m.add_string(self.Q_C.public_bytes(serialization.Encoding.X962,
    ...
    def _parse_kexecdh_init(self, m):
        ...
        # SEC1: V2.0  2.3.3 Elliptic-Curve-Point-to-Octet-String Conversion
        Q_S_bytes = self.Q_S.public_bytes(serialization.Encoding.X962,
                                          serialization.PublicFormat.UncompressedPoint)
    ...
    def _parse_kexecdh_reply(self, m):
        ...
        hm.add_string(K_S)
        # SEC1: V2.0  2.3.3 Elliptic-Curve-Point-to-Octet-String Conversion
        hm.add_string(self.Q_C.public_bytes(serialization.Encoding.X962,
                                            serialization.PublicFormat.UncompressedPoint))
        hm.add_string(Q_S_bytes)
        hm.add_mpint(K)
