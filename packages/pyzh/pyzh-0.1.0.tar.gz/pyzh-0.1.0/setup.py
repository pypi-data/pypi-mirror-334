...
setup(
    ...
    version="0.1.0",  # 版本号
    author="中文编程团队",  # 作者
    author_email="contact@itkt.org",  # 更新为更专业的邮箱
    ...
    url="https://github.com/itkt/pyzh",  # 更新为更合适的项目主页
    ...
    keywords="chinese, programming, education, learning, python, 中文编程, 编程教育, 计算机教育, 编程入门, 中文函数",  # 扩展关键词
    project_urls={
