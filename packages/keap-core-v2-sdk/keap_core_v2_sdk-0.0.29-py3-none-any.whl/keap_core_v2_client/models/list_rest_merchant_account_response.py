...
class ListRestMerchantAccountResponse(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PAYPAL', 'UNSUPPORTED', 'AUTHORIZE', 'E_WAY', 'WEPAY', 'STRIPE', 'KEAP_PAY']):
            raise ValueError("must be one of enum values ('PAYPAL', 'UNSUPPORTED', 'AUTHORIZE', 'E_WAY', 'WEPAY', 'STRIPE', 'KEAP_PAY')")
        return value
