...
class UpdateOrderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contact_id", "lead_affiliate_id", "notes", "order_time", "order_title", "order_type", "promo_codes", "sales_affiliate_id", "shipping_address", "terms"]
