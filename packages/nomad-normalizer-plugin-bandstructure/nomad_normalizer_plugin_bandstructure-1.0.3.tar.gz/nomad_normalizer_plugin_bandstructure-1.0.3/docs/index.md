# Welcome to the `nomad-normalizer-plugin-bandstructure` documentation

This is the normalizer for bandstructure.
...
A series of tutorials will guide you through the main functionality of `nomad-normalizer-plugin-bandstructure`.
