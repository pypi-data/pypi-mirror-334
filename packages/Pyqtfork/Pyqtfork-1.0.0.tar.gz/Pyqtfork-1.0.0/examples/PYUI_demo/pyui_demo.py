...
"""
PYUI Demo Application

This example demonstrates the basic features of PYUI (formerly PyQt5)
...
class PYUIDemo(QMainWindow):
    """Main window for the PYUI demo application"""
    ...
    def initUI(self):
        ...
        self.setWindowTitle('PYUI Demo Application')
        ...
        # Create header
        header_label = QLabel('Welcome to PYUI Demo')
        ...
        # Create description
        desc_label = QLabel('This demo showcases the capabilities of PYUI, an enhanced fork of PyQt5')
    ...
    def test_display(self):
        ...
        test_text = "PYUI Demo Application\n\n"
        test_text += "This is a demonstration of the PYUI framework capabilities.\n"
        test_text += "PYUI is an enhanced fork of PyQt5 with improved features and usability.\n\n"
    ...
    def show_about(self):
        ...
        about_text = "PYUI Demo Application\n\n"
        about_text += "Version 1.0.0\n\n"
        about_text += "PYUI is an enhanced fork of PyQt5, providing improved UI development capabilities for Python.\n\n"
        about_text += "License: GPL v3\n"
        
        QMessageBox.about(self, 'About PYUI Demo', about_text)
