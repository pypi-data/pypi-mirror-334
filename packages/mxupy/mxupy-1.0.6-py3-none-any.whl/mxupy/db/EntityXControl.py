...
class EntityXControl:
    ...
    def get_one(self, select=None, where=None, order_by=None, group_by=None, having=None, offset=None, to_dict=False, recurse=False, backrefs=False, max_depth=1):
        """ 获取单条记录
        ...
        if to_dict:
            ...
            if select:
                ...
                im.data = model_to_dict(
                    res, recurse=recurse, backrefs=backrefs, max_depth=max_depth)
        else:
            im.data = res
    ...
    def get_list(self, select=None, where=None, order_by=None, group_by=None, having=None, limit=None, offset=None, to_dict=False, recurse=False, backrefs=False, max_depth=1):
        ...
        if to_dict:
            ...
            if select:
                ...
                im.data = [model_to_dict(
                    d, recurse=recurse, backrefs=backrefs, max_depth=max_depth) for d in query]
        else:
            im.data = list(query)
    ...
    def update(self, where, model, fields=None, to_dict=False):
        ...
        if im.check_data(f'{self.model_name} 不存在符合条件的记录！').error:
            return im
