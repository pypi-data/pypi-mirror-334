...
class IM(BaseModel):
    ...
    def __init__(self, success=True, msg='seccess', data=None, code=200, type=''):
        """ 初始化结果
    ...
    def check_data(self, msg=None):
        """ 检查数据，一般 get_one 后检查数据是否存在

        Args:
            msg (str): 当数据不存在时给定的提示，给的提示，如果没有指定，则用 EntityControl 中自带的提示
