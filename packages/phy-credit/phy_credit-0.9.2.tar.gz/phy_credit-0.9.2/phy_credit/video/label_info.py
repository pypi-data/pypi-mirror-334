...
class LabelInfo:
    ...
    # JKLEE: get_objects method should return the same format as the add_object method could take
    # If we still want to get annotations first format, we might change the function name to get_framewise_object or something
