...
class BoxCreator(LabelCreator):
    ...
    def create(
        ...
        return Box(
            ...
            coord=coord,
            meta=meta if meta else self.get_meta(class_name, ClassType.BOX),
    ...
    def from_dict(self, box):
        ...
        return Box(
            ...
            meta=box["annotation"]["meta"] if "meta" in box["annotation"] else self.get_meta(
                class_name,
                ClassType.BOX,
            ),
            properties_def=self.object_classes_map[unique_string_builder(
...
class RotatedBoxCreator(LabelCreator):
    ...
    def create(
        ...
        return RotatedBox(
            ...
            coord=coord,
            meta=meta if meta else self.get_meta(class_name, ClassType.RBOX),
            properties_def=self.object_classes_map[unique_string_builder(
                class_name,
                ClassType.RBOX,
            )]["properties"],
    ...
    def from_dict(self, rbox):
        ...
        return RotatedBox(
            ...
            else self.get_meta(class_name, ClassType.RBOX),
            properties_def=self.object_classes_map[unique_string_builder(
                class_name,
                ClassType.RBOX,
            )]["properties"],
...
class PolylineCreator(LabelCreator):
    ...
    def from_dict(self, polyline):
        ...
        return Polyline(
            ...
            else self.get_meta(class_name, ClassType.POLYLINE),
            properties_def=self.object_classes_map[unique_string_builder(
                class_name,
                ClassType.POLYLINE
            )]["properties"],
...
class PolygonCreator(LabelCreator):
    ...
    def from_dict(self, polygon):
        ...
        return Polygon(
            ...
            else self.get_meta(class_name, ClassType.POLYGON),
            properties_def=self.object_classes_map[unique_string_builder(
                class_name,
                ClassType.POLYGON,
            )]["properties"],
...
class KeypointCreator(LabelCreator):
    ...
    def from_dict(self, keypoint):
        ...
        return Keypoint(
            ...
            else self.get_meta(class_name, ClassType.KEYPOINT),
            properties_def=self.object_classes_map[unique_string_builder(
                class_name,
                ClassType.KEYPOINT,
            )]["properties"],
...
class Cuboid2DCreator(LabelCreator):
    ...
    def from_dict(self, cuboid2d):
        ...
        a = Cuboid2D(
            ...
            else self.get_meta(class_name, ClassType.CUBOID2D),
            properties_def=self.object_classes_map[unique_string_builder(
                class_name,
                ClassType.CUBOID2D,
            )]["properties"],
