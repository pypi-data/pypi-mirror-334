...
def make_ts_wrap(x):
    ...
    parser.add_argument('--file',  help='drops columns from data frame', required=True)
    parser.add_argument('--package',   help='drops columns from data frame',default='time_pkg')
    parser.add_argument('--RunInf', help='Enable verbose mode', action='store_true')
