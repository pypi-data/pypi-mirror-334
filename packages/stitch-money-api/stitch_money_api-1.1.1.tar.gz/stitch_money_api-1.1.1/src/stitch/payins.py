...
class Stitch:
    ...
    def initiateCardTransaction(
        ...
        transaction = self._client.initiate_card_transaction(
            mutation_input)
        return transaction
    
    def initiateCardRefundTransaction(
        self,
        originalPaymentId: str,
        quantity: float,
        currency: Currency,
        external_reference: str,
        nonce: str,
        ...
        transaction = self._client.initiate_refund_transaction(
            mutation_input)
        return transaction