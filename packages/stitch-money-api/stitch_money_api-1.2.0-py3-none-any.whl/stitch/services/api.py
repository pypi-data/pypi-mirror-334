...
class ApiClient:
    ...
    def initiate_refund_transaction(self, input: RefundTransactionInitiateInput) -> Transaction:
        ...
        try:
            ...
            if not response or response["__typename"] not in ["CardRefundTransaction", "WalletRefundTransaction"]:
