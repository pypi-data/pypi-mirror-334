...
class Mesh(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_geometry_version_id", b"_geometry_version_id", "create_time", b"create_time", "geometry_version_id", b"geometry_version_id", "id", b"id", "name", b"name", "status", b"status"]) -> None: ...
