...
class Camera(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["direction", b"direction", "look_at", b"look_at", "resolution", b"resolution", "typ", b"typ"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["direction", b"direction", "id", b"id", "look_at", b"look_at", "name", b"name", "projection", b"projection", "resolution", b"resolution", "typ", b"typ"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["typ", b"typ"]) -> typing_extensions.Literal["direction", "look_at"] | None: ...
...
class Filter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["clip", b"clip", "contour", b"contour", "display_attrs", b"display_attrs", "glyph", b"glyph", "slice", b"slice", "streamlines", b"streamlines", "threshold", b"threshold", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["clip", b"clip", "contour", b"contour", "display_attrs", b"display_attrs", "glyph", b"glyph", "id", b"id", "name", b"name", "slice", b"slice", "streamlines", b"streamlines", "threshold", b"threshold", "value", b"value"]) -> None: ...
