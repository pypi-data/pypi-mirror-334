import unittest
import numpy as np
from TimeSeriesRegression.holt_winters import HoltWintersModel
...
class TestHoltWintersModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.model = HoltWintersModel(trend='add', seasonal='add', seasonal_periods=12)  # Khởi tạo mô hình Holt-Winters
    ...
    def test_predict(self):
        ...
        self.assertEqual(len(forecast), 5)  # Đảm bảo rằng số bước dự báo là 5
