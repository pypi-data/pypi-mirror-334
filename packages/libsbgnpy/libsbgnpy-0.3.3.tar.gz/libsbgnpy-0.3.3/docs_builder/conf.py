...
# TODO: html_theme_options['canonical_url'] = 'http://domain.tld/latest/docs/'
html_theme_options = {
...
man_pages = [(master_doc, "libsbgnpy", "libsbgnpy Documentation", [author], 1)]
