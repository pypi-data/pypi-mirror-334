...
class Message(BaseModel):
    """Base class for LSP messages.

    Args:
        jsonrpc (str): The JSONRPC version.
    """
...
class ResponseError(BaseModel):
    """Error object for LSP responses.
...
class ErrorCodes(enum.IntEnum):
    """Enumeration of LSP error codes.

    Attributes:
        PARSE_ERROR (int): Parse error.
        INVALID_REQUEST (int): Invalid request.
        METHOD_NOT_FOUND (int): Method not found.
        INVALID_PARAMS (int): Invalid params.
        INTERNAL_ERROR (int): Internal error.
        SERVER_ERROR_START (int): Server error start.
        SERVER_ERROR_END (int): Server error end.
        SERVER_NOT_INITIALIZED (int): Server not initialized.
        UNKNOWN_ERROR_CODE (int): Unknown error code.
    """
    ...
    SERVER_ERROR_END = JSONRPC_RESERVED_ERROR_RANGE_START  # deprecated

    SERVER_NOT_INITIALIZED = -32002
    UNKNOWN_ERROR_CODE = -32001

    JSONRPC_RESERVED_ERROR_RANGE_END = -32000
    SERVER_ERROR_END = JSONRPC_RESERVED_ERROR_RANGE_END  # deprecated
...
class Notification(Message):
    ...
    Args:
        ...
        params (list | JSONDict): The parameters of the notification.
    """

    method: str
    params: t.Optional[list | JSONDict]
