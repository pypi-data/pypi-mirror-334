...
if __name__ == "__main__":
    ...
    args.add_argument("--dataset-name", type=str, required=True)
    args.add_argument("--varchar-length", type=int, default=255)
    args.add_argument("--pk-length", type=int, default=40)
    args.add_argument("--drop", default=True, action='store_true')
