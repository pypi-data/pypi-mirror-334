...
def pie(p,alpha,beta,phi,labels=[],ybounds=[0,10],npts=100,fname=None,NegativeDemands=True,logs=True,use_figure=1,ax=None):
    """
    Plot pie chart of expenditure shares (an "Engel Pie").
    """
    n,parms = check_args(alpha=alpha,beta=beta,phi=phi)
