...
class PublisherOfferTemplateApi(BaseApi):
    ...
    def list_boilerplates(self, aid: str, categories: List[str], offset: int = 0, limit: int = 100, q: str = None, order_by: str = None, order_direction: str = None, status: str = None, template_type: str = None, ensure_templates_exists: bool = None) -> ApiResponse[List[OfferTemplateCategories]]:
    ...
    def list_by_category(self, aid: str, categories: List[str], offset: int = 0, limit: int = 100, status: str = None, template_type: str = None, q: str = None, order_by: str = None, order_direction: str = None, ensure_templates_exists: bool = None) -> ApiResponse[List[OfferTemplateCategories]]:
