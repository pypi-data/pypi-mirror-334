...
class ANNSModel(PALBase):
    ...
    def delete_models(self, state_ids, connection_context=None, force_status=None):
        """
        Deletes the models.
        ...
        for state_id in state_ids:
            self.delete_model(state_id, connection_context, force_status)
    ...
    def delete_model(self, state_id=None, connection_context=None, force_status=None):
        ...
        force_status = arg('force_status', force_status, bool)
        ...
        try:
            self._call_pal_auto(connection_context,
...
def delete_model(state_id=None, connection_context=None):
    """
    Deletes the model.
