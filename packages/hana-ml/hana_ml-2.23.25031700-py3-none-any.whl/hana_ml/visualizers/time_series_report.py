...
from hana_ml.visualizers.report_builder import ReportBuilder, ChartItem, TableItem, ForcePlotItem
...
class TimeSeriesExplainer(object):
    ...
    @staticmethod
    def get_items_from_best_pipeline(best_pipeline: dataframe.DataFrame, highlighted_metric_name, connections_json_str=None):
        report_builder: ReportBuilder = BestPipelineReport.create_report_builder(best_pipeline.collect(), highlighted_metric_name, connections_json_str)
        items = []
