...
use crate::{
    Frame, InitializationError, Pass, PassObject, PyWindowTarget, Renderable, Renderer, Shader,
};
...
impl Renderer {
    ...
    pub fn render_py(&self, renderable: PyObject, target: &PyWindowTarget) -> Result<(), PyErr> {
