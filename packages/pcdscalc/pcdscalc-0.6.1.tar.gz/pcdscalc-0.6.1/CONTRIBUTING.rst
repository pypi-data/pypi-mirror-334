...
Report bugs at https://github.com/pcdshub/pcdscalc/issues.
...
pcdscalc could always use more documentation, whether
as part of the official pcdscalc docs, in docstrings,
or even on the web in blog posts, articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/pcdshub/pcdscalc/issues.
...
Ready to contribute? Here's how to set up `pcdscalc` for local development.
