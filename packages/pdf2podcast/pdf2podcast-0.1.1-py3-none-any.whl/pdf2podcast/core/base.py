...
class BaseLLM(ABC):
    ...
    def generate_podcast_script(
        self, text: str, complexity: str = "intermediate", **kwargs: Dict[str, Any]
    ) -> str:
        """
        ...
        Args:
            ...
            complexity (str): Desired complexity level of the output
