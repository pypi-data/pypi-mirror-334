...
<div class="nav">
    <a href="${BrowserUrl.appendParams('https://docs.pieces.app/extensions-plugins/jupyterlab')}" style="display: inline-block; text-decoration: none; border-radius: 4px;">Docs</a>		<a href=${BrowserUrl.appendParams("https://pieces.app")} style="display: inline-block; text-decoration: none; border-radius: 4px;">Learn More</a>
</div>
