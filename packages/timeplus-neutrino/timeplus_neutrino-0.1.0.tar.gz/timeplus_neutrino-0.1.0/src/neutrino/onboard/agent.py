...
class DataOnboardingAgent:
    ...
    def inference_mutable_stream(self, data, stream_name, keys, description=""):
        message = f"based on input data : {data}, and stream name : {stream_name}, and keys : {keys} , and description : {description}"
    ...
    async def _recommendations(self, data, ddl, stream_name):
        ...
        message = f"based on input data : {data}, and ddl : {ddl} and stream name : {stream_name}"
        self.runtime.start()
    ...
    def recommendations(self, data, ddl, stream_name):
        return asyncio.run(self._recommendations(data, ddl, stream_name))
