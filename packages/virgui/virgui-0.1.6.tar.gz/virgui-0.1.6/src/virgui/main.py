...
class Window(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setup_katscript_tab()

    # this should be a separate class
    def setup_katscript_tab(self):
        self.kat_text = QtWidgets.QTextBrowser(parent=self.tab3)
        self.tab3_layout.addWidget(self.kat_text)
        self.update_katscript()

    @QtCore.Slot()
    def update_katscript(self):
        kat = self.model.unparse()
    ...
    def on_selection(self):
        ...
        if len(items) == 0:
            ...
            info_table.dataChanged.connect(self.update_katscript)
