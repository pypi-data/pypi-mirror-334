...
class DatabaseMetrics(models.Model):
    ...
    def collect_database_metrics(self):
        ...
        # password = '2e70bab2bdd97a5caf388100e94e1dc23cbf2d96'
        ...
        if uid:
            ...
            database_metrics = model.execute_kw(database, uid, password, "database.metrics", "collect_metrics", [])
    ...
    def odoo_file_health(self):
        ...
        if uid:
            ...
            # Call the custom method
            odoo_file_health = model.execute_kw(database, uid, password, "database.metrics", "odoo_file_health", [])
    ...
    def get_concurrent_session_count(self):
        ...
        if uid:
            ...
            # Call the custom method
            session_count = model.execute_kw(database, uid, password, "database.metrics", "get_concurrent_session_count", [])
