...
class EchartsHandlerContainer:
    ...
    def display_echarts_with_toggle(
        self, options, is_last, button_name="Click me", button_key=""
    ):
        def click_button():
    ...
    def cus_write(self, text, is_last):
        ...
        for part in parts:
            if part.startswith("《") and part.endswith("》"):  # 判断是否为《text》标签
                ...
                if button_name not in all_buttons:
                    ...
                    self.once_container.write(button_name, unsafe_allow_html=True)
