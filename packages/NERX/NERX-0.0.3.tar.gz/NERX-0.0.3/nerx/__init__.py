...
class NER(nn.Module):
    ...
    def forward(self, tokenizies: dict):
        ...
        # CRF解码
        return self._crf_decode(emissions)
    ...
    def fit(self, tokenizies: dict, labels: torch.Tensor):
        ...
        # CRF解码
        return loss, self._crf_decode(emissions)
    ...
    def _crf_decode(self, emissions):
        """
        CRF解码
        ...
        """
        # CRF解码并转换为tensor
        return torch.tensor(self.crf.decode(emissions), dtype=torch.long)
