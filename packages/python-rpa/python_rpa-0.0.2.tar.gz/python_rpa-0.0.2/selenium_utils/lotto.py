...
def buy_lotto_ticket(id, password, ticket_count=5):
    ...
    try:
        ...
        print("5장의 로또를 성공적으로 구매했습니다.")

    except Exception as e:
        print("로또 구매 실패했습니다 :", e)
...
def check_lotto_balance(id, password):
    ...
    try:
        ...
        print(f"현재 로또 잔액은 {balance_text} 입니다")
        print(f"현재 로또 잔액은 {balance}원 입니다.")

    except Exception as e:
        print("로또 잔액 확인 실패했습니다 :", e)
