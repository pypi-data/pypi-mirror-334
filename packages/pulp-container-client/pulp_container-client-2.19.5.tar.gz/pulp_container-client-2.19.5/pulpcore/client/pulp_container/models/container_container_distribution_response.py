...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_last_updated=None, pulp_labels=None, pulp_href=None, content_guard=None, base_path=None, hidden=False, repository=None, name=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
