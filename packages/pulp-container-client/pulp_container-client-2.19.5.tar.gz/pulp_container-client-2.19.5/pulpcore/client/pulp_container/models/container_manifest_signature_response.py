...
class ContainerManifestSignatureResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, pulp_last_updated=None, name=None, digest=None, type=None, key_id=None, timestamp=None, creator=None, signed_manifest=None, local_vars_configuration=None):  # noqa: E501
