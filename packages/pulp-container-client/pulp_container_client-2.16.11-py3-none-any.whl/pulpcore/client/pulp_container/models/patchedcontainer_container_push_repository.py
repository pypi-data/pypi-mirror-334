...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, pulp_labels=None, description=None, manifest_signing_service=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
