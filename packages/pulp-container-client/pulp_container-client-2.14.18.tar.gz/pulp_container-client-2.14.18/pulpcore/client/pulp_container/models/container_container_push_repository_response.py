...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, description=None, latest_version_href=None, pulp_labels=None, pulp_href=None, name=None, pulp_created=None, manifest_signing_service=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
