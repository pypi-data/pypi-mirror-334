...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_created=None, pulp_last_updated=None, versions_href=None, pulp_labels=None, pulp_href=None, manifest_signing_service=None, latest_version_href=None, description=None, name=None, local_vars_configuration=None):  # noqa: E501
