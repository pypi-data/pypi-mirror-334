...
class Column(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aggregation", b"aggregation", "column", b"column", "conditional_aggregation", b"conditional_aggregation", "formula", b"formula", "key", b"key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aggregation", b"aggregation", "column", b"column", "conditional_aggregation", b"conditional_aggregation", "formula", b"formula", "key", b"key", "label", b"label"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["column", b"column"]) -> typing.Literal["key", "aggregation", "conditional_aggregation", "formula"] | None: ...
