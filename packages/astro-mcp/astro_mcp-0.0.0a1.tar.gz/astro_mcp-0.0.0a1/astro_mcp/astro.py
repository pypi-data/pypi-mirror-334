...
class AstroServer(FastMCP):
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        try:
            ...
            try:
                # For Python 3.9+
                spec_resource: Traversable = pkg_resources.files("specs").joinpath("platform_api_spec.yaml")
            ...
            spec_path = root_dir / "specs" / "platform_api_spec.yaml"
