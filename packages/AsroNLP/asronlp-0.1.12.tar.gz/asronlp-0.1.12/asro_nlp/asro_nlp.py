...
from importlib import resources  # Menggunakan importlib untuk akses resource
...
class AsroNLP:
    def __init__(self):
        # Contoh penggunaan resources untuk mengakses file stopwords.txt
        with contextlib.closing(resources.path('asro_nlp.data', 'stopwords.txt')) as p:
    ...
    def initialize_paths(self):
        # Penggunaan path yang sudah diperoleh dari __init__
        self.normalization_path = os.path.join(os.path.dirname(self.stopwords_path), "kamuskatabaku.xlsx")
        self.news_dictionary_path = os.path.join(os.path.dirname(self.stopwords_path), "news_dictionary.txt")
        self.root_words_path = os.path.join(os.path.dirname(self.stopwords_path), "kata-dasar.txt")
        self.lexicon_positive_path = os.path.join(os.path.dirname(self.stopwords_path), "kamus_positive.xlsx")
        self.lexicon_negative_path = os.path.join(os.path.dirname(self.stopwords_path), "kamus_negative.xlsx")


    def load_resources(self):
        # Memastikan semua file tersedia
