...
class CustomerAuth(SensitiveFieldsTrackingMixin, BaseModel):
    ...
    # blocked_by = models.ForeignKey('crm_user.CRMUser', null=True, blank=True, on_delete=models.SET_NULL, related_name='blocked_customers')
    # unblocked_by = models.ForeignKey('crm_user.CRMUser', null=True, blank=True, on_delete=models.SET_NULL, related_name='unblocked_customers')
