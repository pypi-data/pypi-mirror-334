...
class CommissionDistribution(BaseModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['deal_ticket', 'customer'], name='unique_distribution_per_ib')
        ]
...
class IBViewPermission(BaseModel):
    ...
    created_by = models.ForeignKey('crm_user.CRMUser', on_delete=models.SET_NULL, 
