...
class RLAffordOpenDoorMetaCfg(BaseTaskMetaCfg):
    """Base class for the RLAffordOpenDoor task metacfg."""

    def __init__(self, subtask_id=0):
        """Initialize the RLAffordOpenDoor task metacfg."""
        ...
        self.step_repeat: int = 1  # how many simulation steps to run for each step() call
        self.decimation = 3
