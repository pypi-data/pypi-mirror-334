...
@configclass
class LiberoPickOrangeJuiceMetaCfg(BaseTaskMetaCfg):
    """Configuration for the Libero pick orange juice task.
    ...
    traj_filepath = "roboverse_data/trajs/libero/pick_up_the_orange_juice_and_place_it_in_the_basket/v2/franka_v2.pkl"
