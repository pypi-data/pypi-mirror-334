...
@configclass
class LiberoPickAlphabetSoupMetaCfg(BaseTaskMetaCfg):
    """Configuration for the Libero pick alphabet soup task.
    ...
    traj_filepath = "roboverse_data/trajs/libero/pick_up_the_alphabet_soup_and_place_it_in_the_basket/v2/franka_v2.pkl"
