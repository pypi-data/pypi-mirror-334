...
def codetr_train(args):
    ...
    tags = {metric_name: str(current_score), KEY_NETWORK_ARCHITECTURE: network_architecture, "SFT": "Full"}
    alias = None
    ...
    config.metadata['ModelSize'] = mllm_model.artifact["metadata"]['ModelSize']
    response = windmill_client.create_model(workspace_id=workspace_id,
                                            ...
                                            category=mllm_model.artifact["category"],
