    ...
    def _log(
        ...
        if hasattr(min_left, "__iter__") and hasattr(max_left, "__iter__"):
            ...
            if hasattr(min_right, "__iter__") and hasattr(max_right, "__iter__"):
                ...
                for idx in range(len(left_side)):
                    if operator in ["==", "!="]:
                        # (max_left >= min_right) & (min_left <= max_right)
                        logger[idx] += (
                            "["
                            + str(
                        ...
                        logger[idx] += (
                            "["
                            + str(
                                max_right - right_side - min_left[idx] + left_side[idx]
                            )
                            + "]"
                        )
                    elif operator in [">=", ">"]:
                        logger[idx] += (
                            "["
                            + str(
                                min_right - right_side - max_left[idx] + left_side[idx]
                            )
                            + "]"
                        )
        else:
                ...
                for idx in range(len(right_side)):
                    if operator in ["==", "!="]:
                        logger[idx] += (
                            "["
                            + str(
                                min_left - left_side - min_right[idx] + right_side[idx]
                            )
                            + ", "
                            + str(
                                max_left - left_side - max_right[idx] + right_side[idx]
                            )
                            + "]"
                        )
                    elif operator in ["<=", "<"]:
                        logger[idx] += (
                            "["
                            + str(
                                max_right[idx] - right_side[idx] - min_left + left_side
                            )
                            + "]"
                        )
                    elif operator in [">=", ">"]:
                        logger[idx] += (
                            "["
                            + str(
                                min_right[idx] - right_side[idx] - max_left + left_side
                            )
                            + "]"
                        )
