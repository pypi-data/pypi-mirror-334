...
#     Returns:
#         theDD (pd.DataFrame): Summary of average metric values by algorithm and adaptability (delay).
...
#     # Grouping by Delay, Wave, and Length, and summarizing specified metrics
#     metric_columns = {}
...
#     theD = joined_df.groupby(['Delay', 'Wave', 'Length']).agg(**metric_columns).reset_index()
