...
class Email:
    ...
    def baixar_emails(self, folder_id, is_read=False, file_format="eml", subject_filter=None, order_by=None):
        self.manager.baixar_emails(self.username, folder_id, is_read, file_format, subject_filter=None, order_by=None)
