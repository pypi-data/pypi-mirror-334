...
🔍 Tool fzf has no binary_path specified - will attempt auto-detection
🔍 Tool bat has no binary_path specified - will attempt auto-detection
🔍 Tool eza has no binary_path specified - will attempt auto-detection
🔍 Tool zoxide has no binary_path specified - will attempt auto-detection
🔍 Tool delta has no binary_path specified - will attempt auto-detection
🔍 Tool atuin has no binary_path specified - will attempt auto-detection
🔍 Tool git-lfs has no binary_path specified - will attempt auto-detection
🔍 Tool ripgrep has no binary_path specified - will attempt auto-detection
🔍 Tool eget has no binary_path specified - will attempt auto-detection
