...
class RpmModulemd(object):
    ...
    def __init__(self, name=None, stream=None, version=None, static_context=None, context=None, arch=None, artifacts=None, dependencies=None, packages=None, snippet=None, profiles=None, description=None, local_vars_configuration=None):  # noqa: E501
