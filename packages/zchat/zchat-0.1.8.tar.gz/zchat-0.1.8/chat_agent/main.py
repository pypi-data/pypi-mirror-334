...
class ChatAgent:
    ...
    def _handle_missing_credentials(self) -> None:
        """Handle missing API credentials by prompting the user."""
        console.print("[yellow]Together AI API key not found.[/yellow]")
        console.print("You need an API key to use this chat agent.")
        console.print("You can get one at https://together.ai")
        console.print()
        ...
        if set_key:
            ...
            if api_key:
                config.set_together_api_key(api_key)
