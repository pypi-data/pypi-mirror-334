...
class Policy(VaultApiBase):
    def list_policies(self) -> Union[dict[str, Any], Response]:
        """
    ...
    def read_policy(self, name: str) -> Union[dict[str, Any], Response]:
        """
    ...
    def delete_policy(self, name: str) -> Union[dict[str, Any], Response]:
        """
