...
class BodyParamsResource(SyncAPIResource):
    ...
    def duplicate_subproperty(
        self,
        *,
        baz: body_param_duplicate_subproperty_params.Baz | NotGiven = NOT_GIVEN,
        foo: body_param_duplicate_subproperty_params.Foo | NotGiven = NOT_GIVEN,
        foo_bar: body_param_duplicate_subproperty_params.FooBar | NotGiven = NOT_GIVEN,
        mapping: body_param_duplicate_subproperty_params.Mapping | NotGiven = NOT_GIVEN,
        mappings: Iterable[body_param_duplicate_subproperty_params.Mapping] | NotGiven = NOT_GIVEN,
    ...
    def enum_properties(
        self,
        *,
        code: Literal[1, 2] | NotGiven = NOT_GIVEN,
        enabled: Literal[True] | NotGiven = NOT_GIVEN,
        kind: Literal["failed", "success"] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def top_level_shared_type(
        self,
        *,
        bar: SimpleObject | NotGiven = NOT_GIVEN,
