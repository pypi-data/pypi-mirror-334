# Welcome to the `nomad-normalizer-plugin-spectra` documentation

This is the normalizer for spectra.
...
A series of tutorials will guide you through the main functionality of `nomad-normalizer-plugin-spectra`.
