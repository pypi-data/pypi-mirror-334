...
class IDE(_message.Message):
    __slots__ = ("id", "name", "project_id", "environment_id", "owner", "environment_name", "project_name", "instance_type", "aws_role", "azure_application_client_id", "status", "build_id", "base_image_id", "max_idle_time_minutes", "created_at", "image_size_bytes")
    ID_FIELD_NUMBER: _ClassVar[int]
...
class IDEBaseImageWithoutConfig(_message.Message):
    __slots__ = ("id", "status", "description", "name", "from_image", "build_id", "result_image", "updated_at", "image_size_bytes")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    image_size_bytes: int
    def __init__(self, id: _Optional[str] = ..., status: _Optional[_Union[IDEBaseImageState, str]] = ..., description: _Optional[str] = ..., name: _Optional[str] = ..., from_image: _Optional[str] = ..., build_id: _Optional[str] = ..., result_image: _Optional[str] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., image_size_bytes: _Optional[int] = ...) -> None: ...

class IDEBaseImage(_message.Message):
    __slots__ = ("id", "status", "description", "name", "IDEConfig", "from_image", "build_id", "result_image", "updated_at", "image_size_bytes")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
