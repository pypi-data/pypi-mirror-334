...
- state (optional):
    ...
    RecentlyCircleClickRecord = TypedDict(
    ...
    def __init__(
        ...
        setsField: typing.Optional[str] = None,
        sizeField: typing.Optional[str] = None,
        blendMode: typing.Optional[Literal["multiply", "normal", "darken", "lighten", "screen", "overlay", "burn", "dodge"]] = None,
        ...
        recentlyCircleClickRecord: typing.Optional["RecentlyCircleClickRecord"] = None,
