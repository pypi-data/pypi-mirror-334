...
- state (optional):
    ...
    CoordinateCfg = TypedDict(
        "CoordinateCfg",
            {
            "startAngle": NotRequired[typing.Union[int, float, numbers.Number]],
            "endAngle": NotRequired[typing.Union[int, float, numbers.Number]],
            "radius": NotRequired[typing.Union[int, float, numbers.Number]],
            "innerRadius": NotRequired[typing.Union[int, float, numbers.Number]]
        }
    )
    ...
    def __init__(
        ...
        sizeRatio: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
