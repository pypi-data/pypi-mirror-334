...
- state (optional):
    ...
    def __init__(
        ...
        binField: typing.Optional[str] = None,
        stackField: typing.Optional[str] = None,
        binWidth: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        binNumber: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
