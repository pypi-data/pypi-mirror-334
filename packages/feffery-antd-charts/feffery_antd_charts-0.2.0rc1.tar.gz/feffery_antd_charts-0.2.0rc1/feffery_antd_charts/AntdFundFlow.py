...
- recentlyNodeClickRecord (dict; optional):
    ...
    def __init__(
        ...
        behaviors: typing.Optional[typing.Sequence[Literal["drag-canvas", "scroll-canvas", "zoom-canvas", "drag-node"]]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'key', 'className', 'style', 'data', 'width', 'height', 'autoFit', 'nodeCfg', 'edgeCfg', 'behaviors', 'markerCfg', 'minimapCfg', 'layout', 'recentlyNodeClickRecord']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'key', 'className', 'style', 'data', 'width', 'height', 'autoFit', 'nodeCfg', 'edgeCfg', 'behaviors', 'markerCfg', 'minimapCfg', 'layout', 'recentlyNodeClickRecord']
