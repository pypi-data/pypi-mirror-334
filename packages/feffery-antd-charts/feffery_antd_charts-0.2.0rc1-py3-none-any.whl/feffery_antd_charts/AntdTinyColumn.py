...
- state (optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'key', 'className', 'style', 'data', 'meta', 'columnWidthRatio', 'color', 'columnStyle', 'xAxis', 'yAxis', 'width', 'height', 'autoFit', 'padding', 'appendPadding', 'renderer', 'pixelRatio', 'locale', 'limitInPlot', 'tooltip', 'annotations', 'pattern', 'animation', 'recentlyTooltipChangeRecord', 'downloadTrigger', 'theme', 'interactions', 'state']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'key', 'className', 'style', 'data', 'meta', 'columnWidthRatio', 'color', 'columnStyle', 'xAxis', 'yAxis', 'width', 'height', 'autoFit', 'padding', 'appendPadding', 'renderer', 'pixelRatio', 'locale', 'limitInPlot', 'tooltip', 'annotations', 'pattern', 'animation', 'recentlyTooltipChangeRecord', 'downloadTrigger', 'theme', 'interactions', 'state']
