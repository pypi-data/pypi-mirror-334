...
ORGANIZATION_INPUT_CSS_SELECTOR = "input[data-toolbaritem-id^='sh_find'][data-toolbaritem-id$='-tr']"
...
class MiniRpaSapAutomation:
    ...
    def find_organization_data_by_company_code(self, company_code):
        ...
        sleep(2)
        self.web_rpa.wait_element_presence_by_css_selector(ORGANIZATION_SEARCH_CSS_SELECTOR)
        ...
        self.web_rpa.click_or_input_by_css_selector(ORGANIZATION_INPUT_CSS_SELECTOR, 'input', company_code)
        self.click_button('Find')
        sleep(3)
        self.web_rpa.click_element_by_key_word(ORGANIZATION_INPUT_CSS_SELECTOR, "tr[id*='mrss-cont-none-Row'] td:first-child div span", company_code, click_type='double',
                                               click_method='element')
        self.web_rpa.wait_element_invisible_by_css_selector(ORGANIZATION_SEARCH_CSS_SELECTOR)
