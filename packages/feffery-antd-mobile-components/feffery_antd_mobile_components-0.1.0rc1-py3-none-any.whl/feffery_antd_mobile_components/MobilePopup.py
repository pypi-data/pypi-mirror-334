...
- closeOnSwipe (boolean; default False):
    ...
    def __init__(
        ...
        position: typing.Optional[Literal["bottom", "top", "left", "right"]] = None,
        showCloseButton: typing.Optional[bool] = None,
        closeOnSwipe: typing.Optional[bool] = None,
        **kwargs
    ):
        self._prop_names = ['id', 'key', 'style', 'className', 'children', 'visible', 'bodyClassName', 'bodyStyle', 'closeOnMaskClick', 'destroyOnClose', 'forceRender', 'mask', 'maskClassName', 'maskStyle', 'position', 'showCloseButton', 'closeOnSwipe']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'key', 'style', 'className', 'children', 'visible', 'bodyClassName', 'bodyStyle', 'closeOnMaskClick', 'destroyOnClose', 'forceRender', 'mask', 'maskClassName', 'maskStyle', 'position', 'showCloseButton', 'closeOnSwipe']
