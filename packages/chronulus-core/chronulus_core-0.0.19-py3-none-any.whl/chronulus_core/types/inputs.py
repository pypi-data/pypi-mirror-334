...
from .attribute import ImageFromUrl, ImageFromBytes, ImageFromFile, Image, TextFromFile, Text, PdfFromFile, Pdf
...
def are_models_equivalent(model1: BaseModelSubclass, model2: BaseModelSubclass):
