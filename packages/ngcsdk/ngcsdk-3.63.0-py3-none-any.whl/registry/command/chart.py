...
from registry.api.utils import ChartRegistryTarget, str_to_license_metadata
...
class ChartSubCommand(RegistryCommand):  # noqa: D101
    ...
    def update_license_terms(self, args):  # noqa: D102
        self.api.update_license_terms(
            args.target,
            (
                [str_to_license_metadata(license_term) for license_term in args.license_terms]
    ...
    def publish(self, args):  # noqa: D102
        ...
        if args.status:
            ...
            return
        license_terms_specs = [str_to_license_metadata(license_term) for license_term in args.license_terms]
