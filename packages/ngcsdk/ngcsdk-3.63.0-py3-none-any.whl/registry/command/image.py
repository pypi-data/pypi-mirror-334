...
from registry.api.utils import ImageRegistryTarget, str_to_license_metadata
...
class ImageCommand(RegistryCommand):  # noqa: D101
    ...
    def update_license_terms(self, args):  # noqa: D102
        license_terms_specs = (
            [str_to_license_metadata(license_term) for license_term in args.license_terms] if args.license_terms else []
        )
