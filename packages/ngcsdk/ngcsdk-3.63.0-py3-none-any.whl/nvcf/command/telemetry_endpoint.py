...
class TelemetryEndpointCommand(CloudFunctionCommand):  # noqa: D101
    ...
    @CLICommand.arguments("--name", metavar="<name>", help="Telemetry Name", required=True, default=None)
    @CLICommand.arguments("--key", metavar="<key>", help="Telemetry key", required=True, default=None)
    @CLICommand.arguments(
        "--endpoint", metavar="<endpoint>", help="Telemetry endpoint URL", required=True, default=None
    )
    @CLICommand.arguments(
        "--protocol",
        metavar="<protocol>",
    ...
    @CLICommand.command(
        help="Create a new telemetry endpoint.", description="Create a new telemetry endpoint.", aliases=["add"]
    )
