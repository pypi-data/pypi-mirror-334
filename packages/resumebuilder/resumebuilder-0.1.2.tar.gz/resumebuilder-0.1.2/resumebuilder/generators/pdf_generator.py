...
def generate_resume_pdf(resume_data: ResumeData, template_name: str, output_file: str) -> None:
    ...
    doc = SimpleDocTemplate(
        output_file,
        pagesize=letter,
        leftMargin=template_config['margins']['left'] * inch,
        rightMargin=template_config['margins']['right'] * inch,
        topMargin=template_config['margins']['top'] * inch,
        bottomMargin=template_config['margins']['bottom'] * inch
    )
    ...
    add_style_if_not_exists(
        ...
        fontName=template_config['fonts']['header'],
        fontSize=14,
        textColor=colors.HexColor(template_config['colors']['primary']),
        spaceAfter=8
    )
    ...
    add_style_if_not_exists(
        ...
        'Normal',
        styles['Normal'],
        fontName=template_config['fonts']['main'],
        fontSize=10,
        leading=14
    )
...
def generate_cover_letter_pdf(resume_data: ResumeData, cover_letter_data: Dict[str, Any], 
    ...
    add_style_if_not_exists(
        ...
        fontName=template_config['fonts']['main'],
        fontSize=12,
        textColor=colors.HexColor(template_config['colors']['secondary']),
        spaceAfter=4
    )
    ...
    add_style_if_not_exists(
        ...
        fontName=template_config['fonts']['main'],
        fontSize=11,
        spaceBefore=12,  # Add space before closing
        spaceAfter=30    # Space for signature
    )
