...
class HydraEmailManager:
    ...
    def baixar_emails(self, user_email, folder_id, is_read=False, file_format="eml", subject_filter=None, order_by=None):
        if self.headers:
            ...
            if response.status_code == 200:
                ...
                for email in emails:
                    ...
                    if subject_filter and subject_filter.lower() in subject.lower():
                        continue
