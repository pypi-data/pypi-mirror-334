...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, content_guard=None, base_path=None, pulp_labels=None, name=None, pulp_created=None, prn=None, pulp_last_updated=None, hidden=False, no_content_change_since=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
