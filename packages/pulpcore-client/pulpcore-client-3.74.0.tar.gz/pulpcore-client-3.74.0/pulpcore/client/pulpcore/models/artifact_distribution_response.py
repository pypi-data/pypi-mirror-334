...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "name", "pulp_href", "pulp_last_updated", "pulp_labels", "pulp_created", "base_url", "no_content_change_since", "hidden", "base_path", "content_guard"]
