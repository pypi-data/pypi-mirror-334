...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, content_guard=None, hidden=False, pulp_created=None, pulp_labels=None, name=None, pulp_href=None, base_path=None, local_vars_configuration=None):  # noqa: E501
