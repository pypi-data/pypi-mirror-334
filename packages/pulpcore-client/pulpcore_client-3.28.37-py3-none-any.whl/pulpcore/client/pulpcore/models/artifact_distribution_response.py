...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_labels=None, name=None, pulp_created=None, base_url=None, content_guard=None, base_path=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
