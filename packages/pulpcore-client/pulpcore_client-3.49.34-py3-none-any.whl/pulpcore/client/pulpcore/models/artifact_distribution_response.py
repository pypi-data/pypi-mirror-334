...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_created=None, base_url=None, pulp_labels=None, pulp_last_updated=None, base_path=None, hidden=False, pulp_href=None, name=None, local_vars_configuration=None):  # noqa: E501
