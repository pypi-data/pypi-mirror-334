...
from remotivelabs.broker.generated.sync import restbus_api_pb2 as restbus__api__pb2
...
class RestbusServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Configure = channel.unary_unary(
                '/base.RestbusService/Configure',
                request_serializer=restbus__api__pb2.ConfigurationRequest.SerializeToString,
                response_deserializer=common__pb2.Empty.FromString,
                _registered_method=True)
        self.Remove = channel.unary_unary(
                '/base.RestbusService/Remove',
                request_serializer=restbus__api__pb2.FrameRemoveRequest.SerializeToString,
                response_deserializer=common__pb2.Empty.FromString,
                _registered_method=True)
        self.Update = channel.unary_unary(
                '/base.RestbusService/Update',
                request_serializer=restbus__api__pb2.SignalUpdateRequest.SerializeToString,
                response_deserializer=common__pb2.Empty.FromString,
                _registered_method=True)
...
class RestbusServiceServicer(object):
    ...
    def Configure(self, request, context):
        """Configure starts the Restbus if the startOption is START_AFTER_INIT.
        Configure removes any previous configuration before applying the new one.
        """
    ...
    def Remove(self, request, context):
        """Remove removes a frame from the Restbus.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def Close(self, request, context):
        """Close stops and removes the configuration from the Restbus.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RestbusServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Configure': grpc.unary_unary_rpc_method_handler(
                    servicer.Configure,
                    request_deserializer=restbus__api__pb2.ConfigurationRequest.FromString,
                    response_serializer=common__pb2.Empty.SerializeToString,
            ),
            'Remove': grpc.unary_unary_rpc_method_handler(
                    servicer.Remove,
                    request_deserializer=restbus__api__pb2.FrameRemoveRequest.FromString,
                    response_serializer=common__pb2.Empty.SerializeToString,
            ),
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=restbus__api__pb2.SignalUpdateRequest.FromString,
                    response_serializer=common__pb2.Empty.SerializeToString,
            ),
...
class RestbusService(object):
    ...
    def Configure(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/base.RestbusService/Configure',
            restbus__api__pb2.ConfigurationRequest.SerializeToString,
    ...
    def Remove(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/base.RestbusService/Remove',
            restbus__api__pb2.FrameRemoveRequest.SerializeToString,
            common__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def Update(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/base.RestbusService/Update',
            restbus__api__pb2.SignalUpdateRequest.SerializeToString,
            common__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
