...
def load_titanic():
    ...
    # 파일을 로드
    train_loader = torch.load(os.path.join(current_dir, 'data', '00', 'train_loader.pt'), weights_only=True)
    test_loader = torch.load(os.path.join(current_dir, 'data', '00', 'test_loader.pt'), weights_only=True)
