...
type VariableVectorType[State: BaseState] = VariableVectorExpression[State] | tuple[int, ...]

class MatrixExpression[State : BaseState](SingleChildExpressionNode):
    def __add__(self, other: FromAnyTypes) -> MatrixExpression[State]: ...
    def __getitem__(self, key: GetItem.KeyType) -> ScalarPolynomialExpression[State]: ...
    @overload
    ...
    def block_diag(self, others: Iterable[MatrixExpression[State]]) -> MatrixExpression[State]: ...
    ...
    def h_stack(self, others: Iterable[MatrixExpression[State]]) -> MatrixExpression[State]: ...
    ...
    def v_stack(self, others: Iterable[MatrixExpression[State]]) -> MatrixExpression[State]: ...
...
class SymmetricMatrixExpression[State : BaseState](MatrixExpression[State]):
    ...
    def diff(self, variables: VariableVectorType[State]) -> SymmetricMatrixExpression[State]: ...
    def eval(
        self, substitutions: Expression.SubstitutionType,
    ) -> SymmetricMatrixExpression[State]: ...
    @overload
    def kron(self, other: SymmetricMatrixExpression[State]) -> SymmetricMatrixExpression[State]: ...
    @overload
    def kron(self, other: MatrixExpression[State]) -> MatrixExpression[State]: ...
    @property
    ...
    def truncate_monomials(
        self, variables: VariableVectorType[State], degrees: TruncateMonomials.DegreeType
    ) -> SymmetricMatrixExpression[State]: ...
...
class VectorExpression[State : BaseState](MatrixExpression[State]):
    ...
    @overload
    def __matmul__(self, other: RowVectorExpression[State]) -> SymmetricMatrixExpression[State]: ...
    @overload
    def __matmul__(self, other: FromAnyTypes) -> MatrixExpression[State]: ...
    ...
    def combinations(self, degrees: Combinations.DegreeType) -> VectorExpression[State]: ...
    ...
    def parametrize(self, variable: Symbol | str) -> VariableVectorSymbolExpression[State]: ...
    def product(
        self,
    ...
    def v_stack(self, others: Iterable[VectorExpression[State]]) -> VectorExpression[State]: ...
    @property
...
class RowVectorExpression[State : BaseState](MatrixExpression[State]):
    ...
    @overload
    def __matmul__(self, other: SymmetricMatrixExpression[State]) -> RowVectorExpression[State]: ...
    @overload
    def __matmul__(self, other: VectorExpression[State]) -> ScalarPolynomialExpression[State]: ...
    @overload
    def __matmul__(self, other: FromAnyTypes) -> MatrixExpression[State]: ...
    ...
    def diff(self, variables: VariableVectorType[State]) -> RowVectorExpression[State]: ...
    def eval(
        self, substitutions: Expression.SubstitutionType,
    ) -> RowVectorExpression[State]: ...
    def h_stack(self, others: Iterable[RowVectorExpression[State]]) -> RowVectorExpression[State]: ...
    @overload
...
class ScalarPolynomialExpression[State : BaseState](VectorExpression[State]):
    ...
    def h_stack(self, others: Iterable[MatrixExpression[State]]) -> RowVectorExpression[State]: ...
    def to_linear_coefficients(
        self,
        variables: VariableVectorType[State],
        monomials: MonomialVectorExpression[State] | None = None,
...
class MonomialVectorExpression[State : BaseState](VectorExpression[State]):
    @overload
    def __mul__(self, other: MonomialVectorExpression[State]) -> MonomialVectorExpression[State]: ...
    @overload
    def __mul__(self, other: FromAnyTypes) -> VectorExpression[State]: ...
...
class MonomialExpression[State : BaseState](ScalarPolynomialExpression[State], MonomialVectorExpression[State]):
    @overload
    def __mul__(self, other: MonomialExpression[State]) -> MonomialExpression[State]: ...
    @overload
    def __mul__(self, other: FromAnyTypes) -> ScalarPolynomialExpression[State]: ...
...
class VariableExpression[State : BaseState](MonomialExpression[State], VariableVectorSymbolExpression[State]):
