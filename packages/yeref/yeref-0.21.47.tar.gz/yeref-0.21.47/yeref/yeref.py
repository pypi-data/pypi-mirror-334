...
async def jpg_video_preview(bot, chat_id, KEYS_JSON, file_link, BOT_TID, MSG_TYPE, file_id, BASE_D, MEDIA_D, BOT_TOKEN):
    ...
    try:
        if MSG_TYPE == 'photo':
            ...
            result = document_jpg
        tmpls = [photo_jpg, gif_jpg, video_jpg, video_note_jpg, audio_jpg, voice_jpg, sticker_jpg, document_jpg]
...
async def jpg_photo_preview(bot, chat_id, KEYS_JSON, file_link, BOT_TID, MSG_TYPE, MEDIA_D):
    ...
    try:
        if MSG_TYPE == 'photo':
            ...
            result = document_jpg
        tmpls = [photo_jpg, gif_jpg, video_jpg, video_note_jpg, audio_jpg, voice_jpg, sticker_jpg, document_jpg]
        if MSG_TYPE in ['audio', 'voice', 'document'] or file_link in tmpls: return
