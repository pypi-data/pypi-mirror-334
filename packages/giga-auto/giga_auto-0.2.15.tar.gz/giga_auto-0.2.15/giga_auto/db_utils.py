...
class DBUtils():
    ...
    def mongodb_connect(self):
        ...
        # host_str = f"{self.db_config['db_host']}:{self.db_config['db_port']}"
        # if "additional_hosts" in self.db_config:
        #     host_str += "," + ",".join(self.db_config["additional_hosts"])
        ...
        # self.conn = MongoClient(self.db_config["db_url"])
