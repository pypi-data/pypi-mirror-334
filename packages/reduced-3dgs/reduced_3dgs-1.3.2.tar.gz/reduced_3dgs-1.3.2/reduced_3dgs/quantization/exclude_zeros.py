...
class ExcludeZeroSHQuantizer(VectorQuantizer):
    ...
    def generate_codebook(values: torch.Tensor, num_clusters=256, treat_as_zero=1e-8, tol=1e-6, max_iter=500, init_codebook=None):
        ...
        nonzero_centers, nonzero_ids = super(ExcludeZeroSHQuantizer, ExcludeZeroSHQuantizer).generate_codebook(nonzero_values, num_clusters - 1, tol, max_iter, init_codebook)
