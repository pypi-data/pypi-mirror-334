...
from gru.agents.models import MemoryInsertRequest, MemoryUpdateRequest, MemoryDeleteRequest
...
def memory_insert(
    ...
    try:
        ...
        if missing_fields:
            return f"Error: Missing required fields in JSON: {', '.join(missing_fields)}"
