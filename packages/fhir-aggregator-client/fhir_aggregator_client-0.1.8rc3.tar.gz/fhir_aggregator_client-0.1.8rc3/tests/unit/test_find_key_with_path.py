...
def test_group():
    true = True
    false = False
    group = {"resourceType": "Group", "id": "fam-675a7f36-8d2e-11e9-bdce-0a1683597132", "meta": {"versionId": "1", "lastUpdated": "2024-09-23T15:28:21.941-04:00", "source": "#I8dahfpmv0X4ipdQ", "security": [{"system": "http://terminology.hl7.org/CodeSystem/v3-Confidentiality", "code": "U", "display": "unrestricted"}]}, "identifier": [{"system": "phs001232-FamilyIdentifier", "value": "675a7f36-8d2e-11e9-bdce-0a1683597132"}], "type": "person", "actual": true, "name": "675a7f36-8d2e-11e9-bdce-0a1683597132", "member": [{"entity": {"reference": "Patient/1826993"}}, {"entity": {"reference": "Patient/1827059"}}, {"entity": {"reference": "Patient/1827006"}}]}
