...
class Voiceprint:
    def __init__(self, voiceprint_model_path, sample_rate=16000, window_size=512, hop_size=160, mel_bins=64, fmin=50,
                 fmax=8000, freeze_base=False, device="cuda:0", batch_size=16, threshold_prob=0.78,
                 log_dir="/a8root/work/service/algo.audio.model/logs"):
        """
    ...
    def inference(self, audios):
        ...
        for input_files in batch:
            ...
            for file, output in zip(input_files, clipwise_output):
                ...
                self.logger.info("file is: {}, predict label is: {}, prob is: {}".format(file, pred_label, output[1]))
