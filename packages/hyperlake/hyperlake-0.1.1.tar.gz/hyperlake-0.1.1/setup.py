...
with open(os.path.join(here, "hyperlake", "_version.py"), "r", "utf-8") as f:
    exec(f.read(), about)
...
gssapi_require = ["requests_gssapi", "krb5 == 0.5.1"]
...
setup(
    ...
    author_email="pythonclient+hello@ockhamlabs.ai",
    version="0.1.1",
    url="https://github.com/ockhamlabs/hyperlake-python-client",
    packages=find_packages(include=["hyperlake", "hyperlake.*"]),  # Updated to hyperlake
    #package_data={"": ["LICENSE", "README.md"]},
    description=about["__description__"],
    long_description=readme + "\n\nForked from: https://github.com/trinodb/trino-python-client",
    long_description_content_type="text/markdown",
    license="Apache-2.0",
    #license_files=["LICENSE"],  # Add this
    classifiers=[
    ...
    entry_points={
        "sqlalchemy.dialects": [
            "hyperlake = hyperlake.sqlalchemy.dialect:HyperlakeDialect",
        ]
    },
)
