...
from hyperlake.types import NamedRowTuple
from hyperlake.types import POWERS_OF_TEN
from hyperlake.types import Time
from hyperlake.types import Timestamp
from hyperlake.types import TimestampWithTimeZone
from hyperlake.types import TimeWithTimeZone
...
class IntervalDayToSecondMapper(ValueMapper[timedelta]):
    def map(self, value: Any) -> Optional[timedelta]:
        ...
        try:
            ...
            raise hyperlake.exceptions.HyperlakeDataError(error_str) from e
...
class RowMapperFactory:
    """
    Given the 'columns' result from Hyperlake, generate a list of
