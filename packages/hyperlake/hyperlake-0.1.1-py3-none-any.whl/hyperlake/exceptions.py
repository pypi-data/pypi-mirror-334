...
This module defines exceptions for Hyperlake operations. It follows the structure
defined in pep-0249.
"""
...
class HyperlakeAuthError(OperationalError):
    pass


class HyperlakeConnectionError(OperationalError):
    pass


class HyperlakeDataError(NotSupportedError):
    pass


class HyperlakeQueryError(Error):
    ...
    def message(self) -> str:
        return self._error.get("message", "Hyperlake did not return an error message")
...
class HyperlakeExternalError(HyperlakeQueryError, OperationalError):
    pass


class HyperlakeInternalError(HyperlakeQueryError, InternalError):
    pass


class HyperlakeUserError(HyperlakeQueryError, ProgrammingError):
    pass
