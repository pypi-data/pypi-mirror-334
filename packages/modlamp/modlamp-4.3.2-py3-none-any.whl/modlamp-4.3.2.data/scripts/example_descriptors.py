...
pepdesc = PeptideDescriptor("modlamp/data/test.fasta", "Eisenberg")  # use Eisenberg consensus scale
globdesc = GlobalDescriptor("modlamp/data/test.fasta")
...
pepdesc.save_descriptor("descriptors1.csv", header=col_names1)
