...
def create_default_files_and_directories(files: list = [{"name" : ".env", "content" : ["nautobot_url", "vault_url", "nautobot_token", "vault_token", "nautobot_query_filter"]}, {"name" : ".test"}], directories: list = ["_OUTPUT", "parameters"]) -> None:    
    """
