...
def install_additional_packages():
    ...
    try:
        print("Installing compatible version of torchvision (0.20.1)...")
        run_command([sys.executable, "-m", "pip", "install", "torchvision==0.20.1"])
    except subprocess.CalledProcessError as e:
        print(f"Error installing torchvision: {e}. Continuing...")
