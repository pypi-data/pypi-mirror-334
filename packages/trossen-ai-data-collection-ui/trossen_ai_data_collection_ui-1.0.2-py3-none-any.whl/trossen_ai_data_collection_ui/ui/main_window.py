...
class MainWindow(QMainWindow):
    ...
    def start_recording(self) -> None:
        ...
        config = RecordControlConfig(
            ...
            single_task=task_config.get("single_task", "No task definition was provided"),
    ...
    def record(
        ...
        while True:
            ...
            if not self.events["stop_recording"] and (
                ...
                reset_environment(robot, self.events, cfg.reset_time_s)
            ...
            dataset.save_episode(cfg.single_task)  # Save the current episode.
            recorded_episodes += 1
        ...
        dataset.consolidate(cfg.run_compute_stats)  # Compute dataset statistics if requested.
