...
from pleach.api.utils import CurrentActiveUser, check_pleach_version
from pleach.services.auth import utils as auth_utils
from pleach.services.deps import get_settings_service, get_store_service
from pleach.services.store.exceptions import CustomError
from pleach.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_pleach_version(component)
