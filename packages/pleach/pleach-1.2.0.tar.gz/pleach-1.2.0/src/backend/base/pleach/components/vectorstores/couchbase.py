...
from pleach.io import HandleInput, IntInput, SecretStrInput, StrInput
...
class CouchbaseVectorStoreComponent(LCVectorStoreComponent):
    ...
    def build_vector_store(self) -> CouchbaseVectorStore:
        try:
            ...
            msg = "Failed to import Couchbase dependencies. Install it using `pip install pleach[couchbase] --pre`"
