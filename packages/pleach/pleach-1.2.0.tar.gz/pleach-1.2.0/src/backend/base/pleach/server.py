...
from pleach.logging.logger import InterceptHandler


class PleachUvicornWorker(UvicornWorker):
...
class PleachApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "pleach.server.PleachUvicornWorker"
