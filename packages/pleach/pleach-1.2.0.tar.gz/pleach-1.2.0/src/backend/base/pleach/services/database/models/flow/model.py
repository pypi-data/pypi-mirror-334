# Path: src/backend/pleach/services/database/models/flow/model.py
...
if TYPE_CHECKING:
    from pleach.services.database.models import TransactionTable
    from pleach.services.database.models.folder import Folder
    from pleach.services.database.models.message import MessageTable
    from pleach.services.database.models.user import User
