...
from pleach.base.constants import FIELD_FORMAT_ATTRIBUTES, NODE_FORMAT_ATTRIBUTES, ORJSON_OPTIONS
from pleach.initial_setup.constants import STARTER_FOLDER_DESCRIPTION, STARTER_FOLDER_NAME
...
from pleach.services.database.models.folder.constants import DEFAULT_FOLDER_NAME
from pleach.services.database.models.folder.model import Folder, FolderCreate, FolderRead
from pleach.services.database.models.user.crud import get_user_by_username
from pleach.services.deps import get_settings_service, get_storage_service, get_variable_service, session_scope
from pleach.template.field.prompt import DEFAULT_PROMPT_INTUT_TYPES
from pleach.utils.util import escape_json_dump
...
async def load_flows_from_directory() -> None:
    """On pleach startup, this loads all flows from the directory specified in the settings.
...
async def create_or_update_starter_projects(all_types_dict: dict, *, do_create: bool = True) -> None:
    ...
    async with session_scope() as session:
        ...
        for project_path, project in starter_projects:
            ...
            do_update_starter_projects = os.environ.get("PLEACH_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
