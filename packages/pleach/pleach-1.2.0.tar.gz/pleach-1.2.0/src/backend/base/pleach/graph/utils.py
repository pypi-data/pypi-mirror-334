...
from pleach.interface.utils import extract_input_variables_from_prompt
from pleach.schema.data import Data
from pleach.schema.message import Message
from pleach.serialization import serialize
from pleach.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from pleach.services.database.models.transactions.model import TransactionBase
from pleach.services.database.models.vertex_builds.crud import log_vertex_build as crud_log_vertex_build
from pleach.services.database.models.vertex_builds.model import VertexBuildBase
from pleach.services.database.utils import session_getter
from pleach.services.deps import get_db_service, get_settings_service

if TYPE_CHECKING:
    from pleach.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from pleach.graph.schema import InterfaceComponentTypes
