...
from pleach.api.utils import CurrentActiveUser, DbSession, parse_value
from pleach.api.v1.schemas import (
    ConfigResponse,
...
from pleach.custom.custom_component.component import Component
from pleach.custom.utils import build_custom_component_template, get_instance_name, update_component_build_config
from pleach.events.event_manager import create_stream_tokens_event_manager
from pleach.exceptions.api import APIException, InvalidChatInputError
from pleach.exceptions.serialization import SerializationError
from pleach.graph.graph.base import Graph
from pleach.graph.schema import RunOutputs
from pleach.helpers.flow import get_flow_by_id_or_endpoint_name
from pleach.helpers.user import get_user_by_flow_id_or_endpoint_name
from pleach.interface.initialize.loading import update_params_with_load_from_db_fields
from pleach.processing.process import process_tweaks, run_graph_internal
from pleach.schema.graph import Tweaks
from pleach.services.auth.utils import api_key_security, get_current_active_user
from pleach.services.cache.utils import save_uploaded_file
from pleach.services.database.models.flow import Flow
from pleach.services.database.models.flow.model import FlowRead
from pleach.services.database.models.flow.utils import get_all_webhook_components_in_flow
from pleach.services.database.models.user.model import User, UserRead
from pleach.services.deps import get_session_service, get_settings_service, get_telemetry_service
from pleach.services.settings.feature_flags import FEATURE_FLAGS
from pleach.services.telemetry.schema import RunPayload
from pleach.utils.version import get_version_info

if TYPE_CHECKING:
    from pleach.services.event_manager import EventManager
...
# get endpoint to return version of pleach
@router.get("/version")
