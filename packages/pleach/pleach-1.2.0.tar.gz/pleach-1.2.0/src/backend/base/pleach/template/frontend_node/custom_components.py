...
from pleach.template.frontend_node.base import FrontendNode
from pleach.template.template.base import Template

DEFAULT_CUSTOM_COMPONENT_CODE = """from pleach.custom import CustomComponent

from typing import Optional, List, Dict, Union
from pleach.field_typing import (
    AgentExecutor,
    BaseChatMemory,
    BaseLanguageModel,
    BaseLLM,
