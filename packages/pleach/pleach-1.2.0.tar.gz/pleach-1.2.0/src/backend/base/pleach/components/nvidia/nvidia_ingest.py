...
from pleach.io import BoolInput, DropdownInput, FileInput, IntInput, MessageTextInput, Output
...
class NvidiaIngestComponent(Component):
    ...
    try:
        ...
        msg = (
            ...
            "Please install them using your package manager. (e.g. uv pip install pleach[nv-ingest])"
        )
        logger.warning(msg)
        file_types = [msg]
