...
from pleach.helpers.data import docs_to_data
from pleach.io import BoolInput, HandleInput, IntInput, StrInput
...
class FaissVectorStoreComponent(LCVectorStoreComponent):
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="Path to save the FAISS index. It will be relative to where Pleach is running.",
        ),
    ...
    def resolve_path(path: str) -> str:
        """Resolve the path relative to the Pleach root.
