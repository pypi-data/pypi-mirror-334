...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the Pleach run endpoint.
    ...
    Environment Variables:
      - PLEACH_HOST: Base URL for the Pleach server (default: http://localhost:7860)
    ...
    host = os.getenv("PLEACH_HOST", "http://localhost:7860")
    ...
    def run_flow_endpoint(self):
        ...
        payload = {
            "input_value": (
                "Hey, Could you check https://docs.pleach.org for me? Later, could you calculate 1390 / 192 ?"
            ),
            "output_type": "chat",
            "input_type": "chat",
            "tweaks": {},
