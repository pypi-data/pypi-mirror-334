...
import pytest
from pleach.components.helpers.structured_output import StructuredOutputComponent
from pleach.helpers.base_model import build_model_from_schema
from pleach.inputs.inputs import TableInput
...
class TestStructuredOutputComponent(ComponentTestBaseWithoutClient):
    ...
    def test_successful_structured_output_generation_with_patch_with_config(self):
        ...
        with patch("pleach.components.helpers.structured_output.get_chat_result", mock_get_chat_result):
    ...
    @patch("pleach.components.helpers.structured_output.get_chat_result")
