...
import pandas as pd
import pytest
from pleach.components.processing.save_to_file import SaveToFileComponent
from pleach.schema import Data, Message
...
class TestSaveToFileComponent(ComponentTestBaseWithoutClient):
    ...
    def test_save_message(self, component_class):
        ...
        for fmt, expected_content in test_cases:
            ...
            with patch("pleach.components.processing.save_to_file.Path") as mock_path:
