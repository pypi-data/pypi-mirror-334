...
import pytest
from pleach.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
from pleach.schema import Data, DataFrame, Message
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("pleach.components.youtube.youtube_transcripts.YoutubeLoader")
