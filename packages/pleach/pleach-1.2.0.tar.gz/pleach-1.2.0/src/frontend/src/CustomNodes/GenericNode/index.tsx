...
function GenericNode({
  ...
  return (
    ...
    >
      <div className="inline-block p-1 rounded-md bg-gradient-to-br from-slate-400 to-slate-500 shadow-sm group-hover/node:shadow-md transition-all duration-300 mb-2">
  <div className="relative bg-gray-50 dark:bg-gray-800 rounded-md p-1">
    {renderNodeIcon()}
  </div>
</div>
      <div
