...
export default function CollectionPage(): JSX.Element {
  ...
  return (
    <SidebarProvider width="280px">
      ...
      {/* Varun Muppidi Commented Out Folder From Main Page */}
      <div className="flex flex-col justify-between rounded-lg border bg-muted text-card-foreground shadow-sm transition-all px-1 py-1">
      {flows &&
        examples &&
        folders &&
        (flows?.length !== examples?.length || folders?.length > 1) && (
