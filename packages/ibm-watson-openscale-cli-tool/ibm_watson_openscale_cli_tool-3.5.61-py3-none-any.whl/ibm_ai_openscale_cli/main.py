...
def get_argument_parser():
    ...
    parser.add_argument('--env', default='ypprod', help='Environment. Default "ypprod"', choices=['mcspsydprod', 'mcsptorprod', 'ypprod', 'frprod', 'ypqa', 'ypcr', 'ys1dev', 'mcspdev', 'mcspqa', 'icp'])
    ...
    parser.add_argument("--wos-sdk-timeout", help=argparse.SUPPRESS, required=False, default=60, type=int)
