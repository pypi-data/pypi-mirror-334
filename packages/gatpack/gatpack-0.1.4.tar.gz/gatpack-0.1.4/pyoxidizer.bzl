...
def make_exe():
    ...
    # Allow loading from filesystem instead of memory for problematic packages
    ...
    python_config.run_module = "gatpack"  # Replace with your main module name
    ...
    exe = dist.to_python_executable(
        name="gatpack",  # Replace with your desired executable name
    ...
    # Add your project's Python package
    ...
    # Tell PyOxidizer to load these packages from the filesystem
