...
class demon:
    def __init__(self):
        ...
        # Convert Ed25519 private key to X25519 private key for key exchange
        self.identity_x25519_private_key = x25519.X25519PrivateKey.from_private_bytes(self.identity_private_key.private_bytes(
            encoding=serialization.Encoding.Raw,
            format=serialization.PrivateFormat.PKCS8,
            encryption_algorithm=serialization.NoEncryption()
        ))

        self.identity_x25519_public_key = self.identity_x25519_private_key.public_key()
    ...
    def rotate_session_keys(self, recipient_identity_public_key, recipient_signed_prekey_public, recipient_onetime_prekey_public):
        ...
        shared_secret_ik = self.identity_x25519_private_key.exchange(
        ...
        shared_secret_spk = self.identity_x25519_private_key.exchange(
            x25519.X25519PublicKey.from_public_bytes(
        ...
        shared_secret_opk = self.identity_x25519_private_key.exchange(
            x25519.X25519PublicKey.from_public_bytes(
