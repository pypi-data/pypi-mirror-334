...
class Attachment(EntityX):
    ...
    type = CharField(max_length=200, default='attachment')
    code = CharField(max_length=200, null=True)
    icon = CharField(max_length=200, null=True)
    path = CharField(max_length=200)
    desc = CharField(max_length=200, null=True)
    
    # 大小、文件类型、添加时间、创建时间、修改时间
    size = FloatField()
    fileType = CharField(max_length=200, null=True)
    ...
    # 文件版本ID、文件ID
    fileVersionId = CharField(max_length=200, null=True)
    fileId = CharField(max_length=200, null=True)
