...
# JUHE_NEWS_API_KEY = "946ccccad362540f414f4938f82b8e24"
...
async def handle_call_tool(
    ...
    if name == "get_news_list":
        return await get_news_list(arguments["type"])
    elif name == "get_news_content":
        uniquekey = arguments.get("uniquekey")
        if not uniquekey:
            raise ValueError("Missing name or content")
        return await get_news_content(arguments["uniquekey"])
    else:
