...
class AuthSendCode(TLFunction):
    def __init__(self):
        super().__init__("auth.sendCode", 0x721c3d6b, [
...
class AuthSignIn(TLFunction):
    def __init__(self):
        super().__init__("auth.signIn", 0xbcd51581, [
            {"name": "phone_number", "type": "string"},
...
class AuthImportBotAuthorization(TLFunction):
    def __init__(self):
        super().__init__("auth.importBotAuthorization", 0x67a3ff2c, [
            {"name": "api_id", "type": "int"},
            {"name": "api_hash", "type": "string"},
...
class UsersGetUsers(TLFunction):
    def __init__(self):
        super().__init__("users.getUsers", 0x9e8fa6d3, [
