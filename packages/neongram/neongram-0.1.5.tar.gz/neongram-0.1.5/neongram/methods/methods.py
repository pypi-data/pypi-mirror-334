...
class AuthSignIn(TLFunction):
    """Implements the auth.signIn method."""
    ...
    def __init__(self):
        super().__init__(
            ...
            [
                ...
                {"name": "password", "type": "string", "flag": "flags", "bit": 0, "optional": True},
...
class AuthImportBotAuthorization(TLFunction):
    """Implements the auth.importBotAuthorization method."""
...
class UsersGetUsers(TLFunction):
    """Implements the users.getUsers method."""
