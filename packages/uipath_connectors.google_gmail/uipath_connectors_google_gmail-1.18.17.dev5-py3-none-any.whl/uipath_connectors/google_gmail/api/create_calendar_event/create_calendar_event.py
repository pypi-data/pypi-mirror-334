...
def _get_kwargs(
    *,
    ...
    send_notifications: Optional[str] = Field(alias="SendNotifications", default=None),
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        add_conference_data (Optional[bool]):  Default: False.
        calendar (Optional[str]):
        send_notifications (Optional[str]):
        body (CreateCalendarEventRequest):
