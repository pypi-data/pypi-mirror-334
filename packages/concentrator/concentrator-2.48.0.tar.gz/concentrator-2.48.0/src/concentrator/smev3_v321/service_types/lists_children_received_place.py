...
class AttachmentRequestType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, AttachmentRequestType)
...
class AttachmentResponseType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, AttachmentResponseType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def validate_string_255(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 255:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on string-255'
                    % {'value': encode_str_2_3(value), 'lineno': lineno}
                )
                result = False
        return result
...
NamespaceToDefMappings_ = {
    'http://epgu.gosuslugi.ru/concentrator/lists_children_received_place/1.0.0': [
        ('string-10', '../../Загрузки/lists_children_received_place.xsd', 'ST'),
        ('string-50', '../../Загрузки/lists_children_received_place.xsd', 'ST'),
        ('string-255', '../../Загрузки/lists_children_received_place.xsd', 'ST'),
        ('EnvType', '../../Загрузки/lists_children_received_place.xsd', 'ST'),
        ('AttachmentRequestType', '../../Загрузки/lists_children_received_place.xsd', 'CT'),
        ('AttachmentResponseType', '../../Загрузки/lists_children_received_place.xsd', 'CT'),
    ]
}

__all__ = ['AttachmentRequestType', 'AttachmentResponseType']
