...
try:
    ...
    try:
        from generatedssupersuper import (
...
class EduOrganizationDataType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, EduOrganizationDataType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def has__content(self):
        if self.EduOrganizationCode is not None or self.EduOrganizationName is not None:
            return True
        else:
            return False
    ...
    def _exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_='', name_='EduOrganizationDataType'
    ):
        pass
    ...
    def _exportChildren(
        ...
        if self.EduOrganizationName is not None:
            namespaceprefix_ = (
                self.EduOrganizationName_nsprefix_ + ':'
                if (UseCapturedNS_ and self.EduOrganizationName_nsprefix_)
                else ''
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sEduOrganizationName>%s</%sEduOrganizationName>%s'
                % (
                    namespaceprefix_,
                    self.gds_encode(
                        self.gds_format_string(quote_xml(self.EduOrganizationName), input_name='EduOrganizationName')
                    ),
                    namespaceprefix_,
                    eol_,
                )
...
class OtherRepresentativeType(GeneratedsSuper):
    ...
    def _exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_='', name_='OtherRepresentativeType'
    ):
        pass
...
class ChildInfoType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            or self.ChildBirthAct is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(
        ...
        if self.ChildBirthAct is not None:
            namespaceprefix_ = (
                self.ChildBirthAct_nsprefix_ + ':' if (UseCapturedNS_ and self.ChildBirthAct_nsprefix_) else ''
            )
            self.ChildBirthAct.export(
                outfile, level, namespaceprefix_, namespacedef_='', name_='ChildBirthAct', pretty_print=pretty_print
            )
...
class ChildBirthActType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, ChildBirthActType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            self.ChildBirthDocActNumber is not None
            or self.ChildBirthDocActDate is not None
            or self.ChildActBirthDocIssued is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(
        ...
        if self.ChildActBirthDocIssued is not None:
            namespaceprefix_ = (
                self.ChildActBirthDocIssued_nsprefix_ + ':'
                if (UseCapturedNS_ and self.ChildActBirthDocIssued_nsprefix_)
                else ''
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sChildActBirthDocIssued>%s</%sChildActBirthDocIssued>%s'
                % (
                    namespaceprefix_,
                    self.gds_encode(
                        self.gds_format_string(
                            quote_xml(self.ChildActBirthDocIssued), input_name='ChildActBirthDocIssued'
                        )
                    ),
                    namespaceprefix_,
                    eol_,
...
class EntryParamsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            or self.AgreementOnOtherDayGroup is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(
        ...
        if self.AgreementOnOtherDayGroup is not None:
            namespaceprefix_ = (
                self.AgreementOnOtherDayGroup_nsprefix_ + ':'
                if (UseCapturedNS_ and self.AgreementOnOtherDayGroup_nsprefix_)
                else ''
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sAgreementOnOtherDayGroup>%s</%sAgreementOnOtherDayGroup>%s'
                % (
                    namespaceprefix_,
                    self.gds_format_boolean(self.AgreementOnOtherDayGroup, input_name='AgreementOnOtherDayGroup'),
                    namespaceprefix_,
                    eol_,
                )
            )
...
class AdaptationProgramType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            or self.AgreementAdaptationEducationGroup is not None
    ...
    def _exportChildren(
        ...
        if self.AgreementAdaptationEducationGroup is not None:
            namespaceprefix_ = (
                self.AgreementAdaptationEducationGroup_nsprefix_ + ':'
                if (UseCapturedNS_ and self.AgreementAdaptationEducationGroup_nsprefix_)
                else ''
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sAgreementAdaptationEducationGroup>%s</%sAgreementAdaptationEducationGroup>%s'
                % (
                    namespaceprefix_,
                    self.gds_format_boolean(
                        self.AgreementAdaptationEducationGroup, input_name='AgreementAdaptationEducationGroup'
                    ),
                    namespaceprefix_,
                    eol_,
                )
...
class ApplicationType(GeneratedsSuper):
    ...
    def __init__(
        ...
        BenefitInfo=None,
        ConfirmingRightIsLocatedRF=None,
        attribute=None,
        refInfo=None,
        gds_collector_=None,
        **kwargs_,
    ...
    def has__content(self):
        if (
            ...
            or self.ConfirmingRightIsLocatedRF
            or self.attribute
            or self.refInfo
        ):
            return True
    ...
    def _exportChildren(
        ...
        for ConfirmingRightIsLocatedRF_ in self.ConfirmingRightIsLocatedRF:
            namespaceprefix_ = (
                self.ConfirmingRightIsLocatedRF_nsprefix_ + ':'
                if (UseCapturedNS_ and self.ConfirmingRightIsLocatedRF_nsprefix_)
                else ''
            )
            ConfirmingRightIsLocatedRF_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_='',
                name_='ConfirmingRightIsLocatedRF',
                pretty_print=pretty_print,
            )
        ...
        for refInfo_ in self.refInfo:
            ...
            refInfo_.export(
                outfile, level, namespaceprefix_, namespacedef_='', name_='refInfo', pretty_print=pretty_print
            )
...
class GetApplicationQueueRequestType(GeneratedsSuper):
    ...
    def has__content(self):
        if self.orderId is not None or self.attribute or self.refInfo:
            return True
        else:
            return False
...
class cancelRequestType(GeneratedsSuper):
    ...
    def has__content(self):
        if self.orderId is not None or self.reason is not None or self.attribute or self.refInfo:
            return True
        else:
            return False
...
class ApplicationQueueResponseType(GeneratedsSuper):
    ...
    def export(
        ...
        already_processed = set()
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_='ApplicationQueueResponseType'
        )
        if self.has__content():
            outfile.write('>%s' % (eol_,))
            self._exportChildren(
...
class GetApplicationAdmissionResponseType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            or self.AdaptationProgram is not None
            or self.MedicalReport is not None
            or self.EduOrganizationData is not None
            or self.refInfo
            or self.attribute
        ):
            return True
    ...
    def _exportChildren(
        ...
        if self.EduOrganizationData is not None:
            namespaceprefix_ = (
                self.EduOrganizationData_nsprefix_ + ':'
                if (UseCapturedNS_ and self.EduOrganizationData_nsprefix_)
                else ''
            )
            self.EduOrganizationData.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_='',
                name_='EduOrganizationData',
                pretty_print=pretty_print,
            )
        for refInfo_ in self.refInfo:
            namespaceprefix_ = self.refInfo_nsprefix_ + ':' if (UseCapturedNS_ and self.refInfo_nsprefix_) else ''
...
class attributeType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, attributeType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def validate_string_1000(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 1000:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on string-1000'
                    % {'value': encode_str_2_3(value), 'lineno': lineno}
                )
                result = False
        return result
    ...
    def has__content(self):
        if self.attributeName is not None or self.attributeValue:
            return True
        else:
            return False
    ...
    def export(
        ...
        if self.has__content():
            outfile.write('>%s' % (eol_,))
            self._exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_='attributeType', pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def _exportChildren(
        ...
        if self.attributeName is not None:
            namespaceprefix_ = (
                self.attributeName_nsprefix_ + ':' if (UseCapturedNS_ and self.attributeName_nsprefix_) else ''
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sattributeName>%s</%sattributeName>%s'
                % (
                    namespaceprefix_,
                    self.gds_encode(self.gds_format_string(quote_xml(self.attributeName), input_name='attributeName')),
                    namespaceprefix_,
                    eol_,
                )
            )
        for attributeValue_ in self.attributeValue:
            namespaceprefix_ = (
                self.attributeValue_nsprefix_ + ':' if (UseCapturedNS_ and self.attributeValue_nsprefix_) else ''
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sattributeValue>%s</%sattributeValue>%s'
                % (
                    namespaceprefix_,
                    self.gds_encode(self.gds_format_string(quote_xml(attributeValue_), input_name='attributeValue')),
                    namespaceprefix_,
                    eol_,
                )
            )
...
class referenceInfoType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, referenceInfoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def has__content(self):
        if self.Attribute or self.DirectoryValue:
            return True
        else:
            return False
    ...
    def _exportChildren(
        ...
        for DirectoryValue_ in self.DirectoryValue:
            namespaceprefix_ = (
                self.DirectoryValue_nsprefix_ + ':' if (UseCapturedNS_ and self.DirectoryValue_nsprefix_) else ''
            )
            DirectoryValue_.export(
                outfile, level, namespaceprefix_, namespacedef_='', name_='DirectoryValue', pretty_print=pretty_print
            )
...
class directoryValueType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, directoryValueType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
...
class cancelResponseType(GeneratedsSuper):
    ...
    def __init__(
        self, orderId=None, result=None, comment=None, refInfo=None, attribute=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
...
def parseEtree(inFileName, silence=False, print_warnings=True, mapping=None, reverse_mapping=None, nsmap=None):
    ...
    rootElement = rootObj.to_etree(
        None, name_=rootTag, mapping_=mapping, reverse_mapping_=reverse_mapping, nsmap_=nsmap
    )
...
NamespaceToDefMappings_ = {
    'http://epgu.gosuslugi.ru/concentrator/kindergarten/4.0.1': [
        ('stringNN-11', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('stringNN-20', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-6', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-10', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-20', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-21', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-14', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-50', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-256', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-1000', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-1024', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('string-2048', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('CancelResultType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'ST'),
        ('AddressType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
            'EduOrganizationDataType',
            '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd',
            'CT',
        ),
        ('DataElementType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('AppliedDocumentType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('DocInfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('PersonInfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
        ...
        ('ChildInfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('ChildBirthDocRFType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('ChildBirthActType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
            'ChildBirthDocForeignType',
            '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd',
            'CT',
        ),
        ('EntryParamsType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
            'AdaptationProgramType',
            '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd',
            'CT',
        ),
        ('MedicalReportType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
            'MedicalReportWithoutFilesType',
            '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd',
            'CT',
        ),
        ('EduOrganizationType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
        ...
        ('BenefitInfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
            'BenefitInfoWithoutFilesType',
            '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd',
            'CT',
        ),
        ('ApplicationType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
            'ApplicationOrderInfoRequestType',
            '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd',
            'CT',
        ),
        ('Person2InfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
        ...
        ('cancelRequestType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('orderIdType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('statusCodeType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('changeOrderInfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
        ...
        ('attributeType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('referenceInfoType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('directoryValueType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('cancelResponseType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        ('FormDataType', '../concentrator/src/concentrator/smev3_v4/templates/schema/kindergarten401.xsd', 'CT'),
        (
