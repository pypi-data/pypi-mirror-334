    ...
    def __init__(
        ...
        **kwargs_,
        ...
        super(ApplicationOrderInfoRequestTypeSub, self).__init__(
            orderId, ServicesType, PersonInfo, PersonIdentityDocInfo, ChildInfo, attribute, refInfo, **kwargs_
        )
...
class GetApplicationQueueReasonRequestTypeSub(supermod.GetApplicationQueueReasonRequestType):
    def __init__(self, orderId=None, PeriodStart=None, PeriodEnd=None, attribute=None, refInfo=None, **kwargs_):
        super(GetApplicationQueueReasonRequestTypeSub, self).__init__(
            orderId, PeriodStart, PeriodEnd, attribute, refInfo, **kwargs_
        )
...
class ApplicationRejectionRequestTypeSub(supermod.ApplicationRejectionRequestType):
    def __init__(self, orderId=None, eduOrganizationCode=None, comment=None, attribute=None, refInfo=None, **kwargs_):
        super(ApplicationRejectionRequestTypeSub, self).__init__(
            orderId, eduOrganizationCode, comment, attribute, refInfo, **kwargs_
        )
...
class changeOrderInfoTypeSub(supermod.changeOrderInfoType):
    def __init__(
        self, orderId=None, statusCode=None, comment=None, cancelAllowed=None, refInfo=None, attribute=None, **kwargs_
    ):
        super(changeOrderInfoTypeSub, self).__init__(
            orderId, statusCode, comment, cancelAllowed, refInfo, attribute, **kwargs_
        )
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        super(GetApplicationQueueReasonResponseTypeSub, self).__init__(
            orderId, IncreaseQueue, GotAPlace, IncreaseBenefits, refInfo, attribute, **kwargs_
        )
