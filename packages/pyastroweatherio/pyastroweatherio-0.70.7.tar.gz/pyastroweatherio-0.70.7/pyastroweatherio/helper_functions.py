...
class AstronomicalRoutines:
    ...
    def _get_astronomical_darkness(self, date):
    ...
    def _is_moon_dark_whole_night(self, night_start, night_end):
    ...
    def _next_dark_night(self):
        ...
        for i in range(365):
            ...
            if self._is_moon_dark_whole_night(night_start, night_end):
                self._moon_data["next_dark_night"] = night_start
                break
