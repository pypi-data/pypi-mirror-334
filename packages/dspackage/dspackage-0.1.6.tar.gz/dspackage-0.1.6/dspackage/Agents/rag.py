    ...
    def initialize_history_aware_retriever(
        ...
        if self.model_name == "llama":
            ...
            try:
                ...
                raise ImportError(
                    "GPT model requires `dspackage[langchain_gpt]`. Install it with `pip install dspackage["
                    "langchain_gpt]`.")
            # noinspection PyArgumentList
            llm = ChatOpenAI(
                model="gpt-4o",
            ...
            raise ValueError(
                "Please select among available models.",
                "Available models are: llama, deepseek, gpt."
            )
