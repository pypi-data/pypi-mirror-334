...
#acabei de criar abaixo
    ...
    @staticmethod
    def insertLoading(loadingId, pathtogif, speed=100):
        """
        Insere um GIF animado de loading na tela.
        :param loadingId: ID do loading.
        :param pathtogif: Caminho do GIF.
        :param speed: Velocidade da animação em milissegundos (quanto menor, mais lento).
        """
        ...
        try:
            ...
            def update_frame():
                if loadingId in GraphiteInter._loadings:
                    ...
                    # Inverte a lógica: valores menores de speed resultam em mais lento
