...
class BrowserTab:
    ...
    def run_on_new_document(
        ...
        if script:
            ...
            return self.run_cdp_command(cdp.page.add_script_to_evaluate_on_new_document(load_script_if_js_file(script)))
...
class Driver(BrowserTab):
    ...
    def reload(self, js_to_run_before_new_document=None) -> Tab:
        self._tab.reload(script_to_evaluate_on_load=load_script_if_js_file(js_to_run_before_new_document))
