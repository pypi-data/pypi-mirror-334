...
class DataScouter:
    def __init__(self, kaggle_api_key=None, relevance_threshold=0.3, source_filter=None):
        ...
        self.kaggle_api_key = kaggle_api_key or os.getenv("KAGGLE_API_KEY")
...
if __name__ == "__main__":
    search_engine = DataScouter(kaggle_api_key="d6e7b438128d0a673eea44ece0cf1a83")
