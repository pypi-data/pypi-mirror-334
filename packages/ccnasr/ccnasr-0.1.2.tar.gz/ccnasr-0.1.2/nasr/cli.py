...
def add_common_arguments(parser: ArgumentParser, is_main_parser: bool) -> None:
    ...
    parser.add_argument(
        ...
        metavar="PATH",
        help="Path to the directory where log files should be stored in. If not specified, nasr will print to stdout.",
    )
