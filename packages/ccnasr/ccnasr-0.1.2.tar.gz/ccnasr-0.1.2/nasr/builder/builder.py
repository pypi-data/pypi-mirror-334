...
from nasr.compilerstore import CompilerStore, BuiltCompilerInfo
from nasr.defaults import DEFAULT_PATCH_DIR
        ...
        if worker_pid_file.exists():
            if _worker_alive(worker_pid_file):
                raise DuplicateBuildException(
                    ...
                    "or the cache in a bad state (run nasr cache clean to fix)."
                )
