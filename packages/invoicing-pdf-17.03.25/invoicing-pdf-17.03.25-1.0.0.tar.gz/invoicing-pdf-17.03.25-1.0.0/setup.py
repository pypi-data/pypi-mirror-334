...
setup(
    name='invoicing-pdf-17.03.25',  #* Your package will have this name
    ...
    author='Richard Bajan',  # Your name
    author_email='your.email@example.com',  # Your email
    url='https://github.com/Anc1kr1st',  # Homepage of your library (e.g. github or your website)
