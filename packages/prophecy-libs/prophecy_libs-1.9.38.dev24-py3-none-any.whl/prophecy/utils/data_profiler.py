...
class Profile:
    def __init__(
        ...
        top_values: Optional[List[TopBin]] = None,
        histograms: Optional[List[HistogramBin]] = None,
    ):
...
class DataProfiler:
    ...
    def _is_skippable_type(col_type: DataType) -> bool:
        return isinstance(col_type, (ArrayType, MapType, StructType, BinaryType))
    ...
    def _profile_columns(
        ...
        for col_name, col_type in columns_info:
            ...
            is_str_type = isinstance(col_type, (StringType, CharType, VarcharType))
            ...
            if calculate_histograms and min_val is not None and max_val is not None:
                ...
                if isinstance(col_type, NumericType):
                    ...
                    days_range = F.datediff(F.lit(max_val), F.lit(min_val))
