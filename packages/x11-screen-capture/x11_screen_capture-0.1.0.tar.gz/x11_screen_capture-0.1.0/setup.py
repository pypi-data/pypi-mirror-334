...
class CustomInstallLib(install_lib):
    def install(self):
        ...
        install_so_path = lib_dir / "screen_capture" / "screen_capture_module.so"
...
setup(
    ...
    url="https://github.com/thelamer/screen_captuire_module",
    packages=setuptools.find_packages(),
    package_dir={"screen_capture": "screen_capture"},
    ext_modules=[
        Extension(
            "screen_capture.screen_capture_module",
            sources=[],
        )
    ],
    cmdclass={
    ...
    package_data={"screen_capture": ["*.so"]},
    classifiers=[
