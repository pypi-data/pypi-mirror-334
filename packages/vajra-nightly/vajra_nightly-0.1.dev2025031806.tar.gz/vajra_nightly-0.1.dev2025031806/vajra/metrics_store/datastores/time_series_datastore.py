...
from vajra._native.metrics_store import TimeSeriesDataStore as TimeSeriesDataStoreC
from vajra._native.metrics_store import unit_type_to_string

from ..datastores.base_datastore import BaseDataStore
from ..plotter import Plotter


class TimeSeriesDataStore(BaseDataStore):
    def __init__(
        self,
        metric: Metric,
        plot_dir: str,
    ...
    def to_df(self) -> pd.DataFrame:
        unit_type_string = unit_type_to_string(self.metric.unit)
    ...
    def plot(self) -> None:
        ...
        Plotter.plot_time_series(
            df,
            self.metric.name,
            unit_type_to_string(self.metric.unit),
