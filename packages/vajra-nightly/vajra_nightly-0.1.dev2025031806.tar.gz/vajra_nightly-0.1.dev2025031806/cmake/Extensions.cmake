...
define_vajra_static(_kernels_common "${KERNEL_COMMON_SRC}" "")

file(GLOB_RECURSE KERNELS_SRC "csrc/vajra/kernels/*.cpp")
define_vajra_extension(_kernels "${KERNELS_SRC}" "_kernels_common")
define_vajra_static(_kernels_static "${KERNELS_SRC}" "_kernels_common")

file(GLOB_RECURSE NATIVE_SRC "csrc/vajra/native/**/*.cpp")
define_vajra_extension(_native "${NATIVE_SRC};csrc/vajra/native/pybind.cpp" "_kernels_common")
define_vajra_static(_native_static "${NATIVE_SRC}" "_kernels_common")