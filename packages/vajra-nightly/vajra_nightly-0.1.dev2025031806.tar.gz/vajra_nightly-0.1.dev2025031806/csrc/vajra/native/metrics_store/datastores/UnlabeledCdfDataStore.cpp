...
//==============================================================================
void UnlabeledCdfDataStore::Merge(const UnlabeledCdfDataStore& other) {
...
//==============================================================================
size_t UnlabeledCdfDataStore::Count() const {
  return static_cast<size_t>(sketch_.num_values());
}
//==============================================================================
size_t UnlabeledCdfDataStore::ZeroCount() const {
  // Use accessors instead of direct member access
  return static_cast<size_t>(sketch_.zero_count());
}
//==============================================================================
...
//==============================================================================
UnlabeledCdfDataStore UnlabeledCdfDataStore::FromSerializedString(
  ...
  return UnlabeledCdfDataStore(reconstructed_sketch);
}
//==============================================================================
}  // namespace vajra
//==============================================================================
