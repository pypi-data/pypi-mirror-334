...
from odoo.osv import expression as this
...
UNARY_OPERATORS = [NOT_OPERATOR]
BINARY_OPERATORS = [AND_OPERATOR, OR_OPERATOR]
...
class Domain(list):
    ...
    def TRUE(cls):
        ...
        return cls(TRUE_DOMAIN)

    @classproperty
    def FALSE(cls):
        "The domain which is False.  Implemented as ``[(0, '=', 1)]``."
        return cls(FALSE_DOMAIN)
