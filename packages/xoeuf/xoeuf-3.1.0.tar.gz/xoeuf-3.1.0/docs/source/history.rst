...
2025-03-15.  Release 3.1.0
--------------------------

- Deprecate module `xoeuf.signals`:mod:
- Remove ``xoeuf.api.from_active_ids``
- Add `BaseModel.iter_pages <xoeuf.models.BaseModel.iter_pages>`:meth:
- Add `xoeuf.fields.UUID`:class:
- Add `xoeuf.fields.Pydantic`:class:
- Add `xoeuf.pydantic_adapter.setup_pydantic_adapter`:func:

2024-07-22.  Release 3.0.8
--------------------------

- Allow ``xotl.tools`` 3.2.


2024-07-12.  Release 3.0.7
--------------------------

- Fix dependency issues.

  Remove dependency from ``ruff``, which is a dev-only dependency.

2024-03-07.  Release 3.0.6
--------------------------

- Recover symbols from ``odoo.osv.expression`` in ``xoeuf.osv.expression``.

- Remove deprecated ``xoeuf.osv.orm.get_modelname``.


2024-03-06.  Release 3.0.5
--------------------------

- Allow ``xotl.tool`` up to version ``3.1.*``.


2024-03-03.  Release 3.0.4
--------------------------

- Fix import errors while using `xoeuf.api`:mod: as replacement of
  ``odoo.api``.


2024-03-03.  Release 3.0.3
--------------------------
...
- Change the default of `leak_context` in ``xoeuf.api.from_active_ids``.  Also
  ``xoeuf.api.from_active_ids`` does not change the value 'active_model' in
  the context.
...
- Improve the decorator ``xoeuf.api.from_active_ids`` to have `leak_context`
