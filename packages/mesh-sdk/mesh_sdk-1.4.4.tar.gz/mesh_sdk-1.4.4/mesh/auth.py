...
def is_authenticated() -> bool:
    ...
    return token_data is not None and is_token_valid(token_data)
    ...
    if token_data and not is_token_valid(token_data):
        ...
        try:
            ...
            if refreshed_token and is_token_valid(refreshed_token):
                ...
                logger.info("Token refresh failed, will proceed with authentication")
        except Exception as e:
