...
from .auth import authenticate, clear_token
...
def _get_client() -> MeshClient:
    ...
    if not token_data or not is_token_valid(token_data):
        ...
        try:
            ...
            # Use device flow in notebook environments
            if in_notebook:
                logger.info("Detected notebook environment, using device code flow authentication")
