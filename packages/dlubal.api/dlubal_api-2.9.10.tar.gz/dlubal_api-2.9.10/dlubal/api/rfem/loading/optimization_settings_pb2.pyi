...
class OptimizationSettings(_message.Message):
    ...
    optimization_values_table: OptimizationSettingsOptimizationValuesTable
    total_number_of_mutations: int
    comment: str
    id_for_export_import: str
    metadata_for_export_import: str
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., active: bool = ..., target_value_type: _Optional[_Union[OptimizationSettingsTargetValueType, str]] = ..., target_global_parameter: _Optional[int] = ..., optimizer_type: _Optional[_Union[OptimizationSettingsOptimizerType, str]] = ..., percent_of_mutations: _Optional[float] = ..., optimization_values_table: _Optional[_Union[OptimizationSettingsOptimizationValuesTable, _Mapping]] = ..., total_number_of_mutations: _Optional[int] = ..., comment: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class OptimizationSettingsOptimizationValuesTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[OptimizationSettingsOptimizationValuesTableRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[OptimizationSettingsOptimizationValuesTableRow, _Mapping]]] = ...) -> None: ...

class OptimizationSettingsOptimizationValuesTableRow(_message.Message):
