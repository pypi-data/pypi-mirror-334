...
class CombinationWizardInitialStateItemsDefinitionType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_FINAL_STATE: _ClassVar[CombinationWizardInitialStateItemsDefinitionType]
    COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_STIFFNESS: _ClassVar[CombinationWizardInitialStateItemsDefinitionType]
    COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_STRAINS: _ClassVar[CombinationWizardInitialStateItemsDefinitionType]
    COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_STRAINS_WITH_USER_DEFINED_FACTORS: _ClassVar[CombinationWizardInitialStateItemsDefinitionType]
...
COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_FINAL_STATE: CombinationWizardInitialStateItemsDefinitionType
COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_STIFFNESS: CombinationWizardInitialStateItemsDefinitionType
COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_STRAINS: CombinationWizardInitialStateItemsDefinitionType
COMBINATION_WIZARD_INITIAL_STATE_ITEMS_DEFINITION_TYPE_STRAINS_WITH_USER_DEFINED_FACTORS: CombinationWizardInitialStateItemsDefinitionType
...
class CombinationWizardInitialStateItemsRow(_message.Message):
    ...
    description: str
    case_object: int
    definition_type: CombinationWizardInitialStateItemsDefinitionType
    def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., case_object: _Optional[int] = ..., definition_type: _Optional[_Union[CombinationWizardInitialStateItemsDefinitionType, str]] = ...) -> None: ...
