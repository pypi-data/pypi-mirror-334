...
class ActionCombinationItemsOperatorType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ACTION_COMBINATION_ITEMS_OPERATOR_TYPE_OR: _ClassVar[ActionCombinationItemsOperatorType]
    ACTION_COMBINATION_ITEMS_OPERATOR_TYPE_AND: _ClassVar[ActionCombinationItemsOperatorType]
    ACTION_COMBINATION_ITEMS_OPERATOR_TYPE_NONE: _ClassVar[ActionCombinationItemsOperatorType]

class ActionCombinationItemsActionLoadType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ACTION_COMBINATION_ITEMS_ACTION_LOAD_TYPE_TRANSIENT: _ClassVar[ActionCombinationItemsActionLoadType]
    ACTION_COMBINATION_ITEMS_ACTION_LOAD_TYPE_PERMANENT: _ClassVar[ActionCombinationItemsActionLoadType]

class ActionCombinationItemsGroupLoadType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ACTION_COMBINATION_ITEMS_GROUP_LOAD_TYPE_TRANSIENT: _ClassVar[ActionCombinationItemsGroupLoadType]
    ACTION_COMBINATION_ITEMS_GROUP_LOAD_TYPE_PERMANENT: _ClassVar[ActionCombinationItemsGroupLoadType]
...
ACTION_COMBINATION_ITEMS_OPERATOR_TYPE_OR: ActionCombinationItemsOperatorType
ACTION_COMBINATION_ITEMS_OPERATOR_TYPE_AND: ActionCombinationItemsOperatorType
ACTION_COMBINATION_ITEMS_OPERATOR_TYPE_NONE: ActionCombinationItemsOperatorType
ACTION_COMBINATION_ITEMS_ACTION_LOAD_TYPE_TRANSIENT: ActionCombinationItemsActionLoadType
ACTION_COMBINATION_ITEMS_ACTION_LOAD_TYPE_PERMANENT: ActionCombinationItemsActionLoadType
ACTION_COMBINATION_ITEMS_GROUP_LOAD_TYPE_TRANSIENT: ActionCombinationItemsGroupLoadType
ACTION_COMBINATION_ITEMS_GROUP_LOAD_TYPE_PERMANENT: ActionCombinationItemsGroupLoadType
...
class ActionCombination(_message.Message):
    ...
    items: ActionCombinationItemsTable
    active: bool
    ...
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., attribute_always_editable: _Optional[str] = ..., comment: _Optional[str] = ..., design_situation: _Optional[int] = ..., items: _Optional[_Union[ActionCombinationItemsTable, _Mapping]] = ..., active: bool = ..., construction_stage: _Optional[int] = ..., combination_type: _Optional[_Union[ActionCombinationCombinationType, str]] = ..., generated_load_combinations: _Optional[_Iterable[int]] = ..., generated_result_combinations: _Optional[_Iterable[int]] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class ActionCombinationItemsTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[ActionCombinationItemsRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[ActionCombinationItemsRow, _Mapping]]] = ...) -> None: ...

class ActionCombinationItemsRow(_message.Message):
    ...
    description: str
    action_item: int
    operator_type: ActionCombinationItemsOperatorType
    left_parenthesis: bool
    right_parenthesis: bool
    group_factor: float
    action_factor: float
    action_load_type: ActionCombinationItemsActionLoadType
    group_load_type: ActionCombinationItemsGroupLoadType
    action: int
    is_leading: bool
    gamma: float
    psi: float
