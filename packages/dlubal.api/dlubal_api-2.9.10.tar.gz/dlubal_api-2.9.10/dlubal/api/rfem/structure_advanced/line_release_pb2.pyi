...
class LineRelease(_message.Message):
    ...
    define_release_type_table: LineReleaseDefineReleaseTypeTable
    comment: str
    id_for_export_import: str
    metadata_for_export_import: str
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., lines: _Optional[_Iterable[int]] = ..., line_release_type: _Optional[int] = ..., release_location: _Optional[_Union[LineReleaseReleaseLocation, str]] = ..., released_members: _Optional[_Iterable[int]] = ..., released_surfaces: _Optional[_Iterable[int]] = ..., released_solids: _Optional[_Iterable[int]] = ..., use_nodes_as_definition_nodes: _Optional[_Iterable[int]] = ..., generated_released_objects: _Optional[_Iterable[int]] = ..., deactivated: bool = ..., define_release_type_for_each_object: bool = ..., define_release_type_table: _Optional[_Union[LineReleaseDefineReleaseTypeTable, _Mapping]] = ..., comment: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class LineReleaseDefineReleaseTypeTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[LineReleaseDefineReleaseTypeTableRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[LineReleaseDefineReleaseTypeTableRow, _Mapping]]] = ...) -> None: ...

class LineReleaseDefineReleaseTypeTableRow(_message.Message):
