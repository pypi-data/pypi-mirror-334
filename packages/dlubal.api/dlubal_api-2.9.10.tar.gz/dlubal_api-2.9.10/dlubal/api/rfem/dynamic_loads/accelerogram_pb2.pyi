...
class Accelerogram(_message.Message):
    ...
    user_defined_accelerogram: AccelerogramUserDefinedAccelerogramTable
    comment: str
    is_generated: bool
    generating_object_info: str
    id_for_export_import: str
    metadata_for_export_import: str
    def __init__(self, no: _Optional[int] = ..., definition_type: _Optional[_Union[AccelerogramDefinitionType, str]] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., library_id: _Optional[int] = ..., user_defined_accelerogram_step_enabled: bool = ..., user_defined_accelerogram_time_step: _Optional[float] = ..., user_defined_accelerogram_sorted: bool = ..., user_defined_accelerogram: _Optional[_Union[AccelerogramUserDefinedAccelerogramTable, _Mapping]] = ..., comment: _Optional[str] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class AccelerogramUserDefinedAccelerogramTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[AccelerogramUserDefinedAccelerogramRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[AccelerogramUserDefinedAccelerogramRow, _Mapping]]] = ...) -> None: ...

class AccelerogramUserDefinedAccelerogramRow(_message.Message):
