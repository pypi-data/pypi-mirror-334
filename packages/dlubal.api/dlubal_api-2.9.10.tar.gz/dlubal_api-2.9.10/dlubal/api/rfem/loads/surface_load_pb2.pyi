...
class SurfaceLoadLoadType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    SURFACE_LOAD_LOAD_TYPE_SNOW: _ClassVar[SurfaceLoadLoadType]
...
SURFACE_LOAD_LOAD_TYPE_SNOW: SurfaceLoadLoadType
...
class SurfaceLoad(_message.Message):
    ...
    varying_load_parameters: SurfaceLoadVaryingLoadParametersTable
