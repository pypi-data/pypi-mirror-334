...
class Borehole(_message.Message):
    ...
    layers_table: BoreholeLayersTable
    layers_thickness_sum: float
    comment: str
    id_for_export_import: str
    metadata_for_export_import: str
    def __init__(self, no: _Optional[int] = ..., type: _Optional[_Union[BoreholeType, str]] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., coordinates: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., coordinate_0: _Optional[float] = ..., coordinate_1: _Optional[float] = ..., coordinate_2: _Optional[float] = ..., import_coordinate_z_from_terrain: bool = ..., groundwater: bool = ..., groundwater_ordinate: _Optional[float] = ..., layers_table: _Optional[_Union[BoreholeLayersTable, _Mapping]] = ..., layers_thickness_sum: _Optional[float] = ..., comment: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class BoreholeLayersTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[BoreholeLayersTableRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[BoreholeLayersTableRow, _Mapping]]] = ...) -> None: ...

class BoreholeLayersTableRow(_message.Message):
    __slots__ = ("no", "description", "layer_no", "soil_material", "thickness", "bottom_ordinate")
    NO_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., layer_no: _Optional[int] = ..., soil_material: _Optional[int] = ..., thickness: _Optional[float] = ..., bottom_ordinate: _Optional[float] = ...) -> None: ...
