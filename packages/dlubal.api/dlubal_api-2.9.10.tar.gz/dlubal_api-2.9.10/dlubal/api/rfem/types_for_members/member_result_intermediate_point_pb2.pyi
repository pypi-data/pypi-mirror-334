...
class MemberResultIntermediatePoint(_message.Message):
    ...
    distances: MemberResultIntermediatePointDistancesTable
    comment: str
    is_generated: bool
    generating_object_info: str
    id_for_export_import: str
    metadata_for_export_import: str
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., members: _Optional[_Iterable[int]] = ..., point_count: _Optional[int] = ..., uniform_distribution: bool = ..., distances_are_defined_as_absolute: bool = ..., distances: _Optional[_Union[MemberResultIntermediatePointDistancesTable, _Mapping]] = ..., comment: _Optional[str] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class MemberResultIntermediatePointDistancesTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[MemberResultIntermediatePointDistancesRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[MemberResultIntermediatePointDistancesRow, _Mapping]]] = ...) -> None: ...

class MemberResultIntermediatePointDistancesRow(_message.Message):
