...
class ThicknessLayersReferenceTableLayerType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    THICKNESS_LAYERS_REFERENCE_TABLE_LAYER_TYPE_E_LAYER_TYPE_LAYER: _ClassVar[ThicknessLayersReferenceTableLayerType]
    THICKNESS_LAYERS_REFERENCE_TABLE_LAYER_TYPE_E_LAYER_TYPE_CONTACT: _ClassVar[ThicknessLayersReferenceTableLayerType]
    THICKNESS_LAYERS_REFERENCE_TABLE_LAYER_TYPE_E_LAYER_TYPE_GAS: _ClassVar[ThicknessLayersReferenceTableLayerType]

class ThicknessLayersReferenceTableEdgeFinishingType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_CLEAN_CUT_EDGES: _ClassVar[ThicknessLayersReferenceTableEdgeFinishingType]
    THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_NONE: _ClassVar[ThicknessLayersReferenceTableEdgeFinishingType]
    THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_POLISHED_EDGES: _ClassVar[ThicknessLayersReferenceTableEdgeFinishingType]
    THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_SEAMED_EDGES: _ClassVar[ThicknessLayersReferenceTableEdgeFinishingType]
...
THICKNESS_LAYERS_REFERENCE_TABLE_LAYER_TYPE_E_LAYER_TYPE_LAYER: ThicknessLayersReferenceTableLayerType
THICKNESS_LAYERS_REFERENCE_TABLE_LAYER_TYPE_E_LAYER_TYPE_CONTACT: ThicknessLayersReferenceTableLayerType
THICKNESS_LAYERS_REFERENCE_TABLE_LAYER_TYPE_E_LAYER_TYPE_GAS: ThicknessLayersReferenceTableLayerType
THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_CLEAN_CUT_EDGES: ThicknessLayersReferenceTableEdgeFinishingType
THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_NONE: ThicknessLayersReferenceTableEdgeFinishingType
THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_POLISHED_EDGES: ThicknessLayersReferenceTableEdgeFinishingType
THICKNESS_LAYERS_REFERENCE_TABLE_EDGE_FINISHING_TYPE_SEAMED_EDGES: ThicknessLayersReferenceTableEdgeFinishingType
...
class Thickness(_message.Message):
    ...
    comment: str
    layers_reference_table: ThicknessLayersReferenceTable
    ...
    function_data_coefficients: ThicknessFunctionDataCoefficientsTable
...
class ThicknessLayersReferenceTableRow(_message.Message):
    ...
    description: str
    layer_no: int
    layer_type: ThicknessLayersReferenceTableLayerType
    ...
    edge_finishing_type: ThicknessLayersReferenceTableEdgeFinishingType
    comment: str
    specific_weight: float
    weight: float
    def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., layer_no: _Optional[int] = ..., layer_type: _Optional[_Union[ThicknessLayersReferenceTableLayerType, str]] = ..., thickness_type_or_id: _Optional[str] = ..., material: _Optional[int] = ..., thickness: _Optional[float] = ..., angle: _Optional[float] = ..., integration_points: _Optional[int] = ..., connection_with_other_topological_elements: bool = ..., edge_finishing_type: _Optional[_Union[ThicknessLayersReferenceTableEdgeFinishingType, str]] = ..., comment: _Optional[str] = ..., specific_weight: _Optional[float] = ..., weight: _Optional[float] = ...) -> None: ...

class ThicknessFunctionDataCoefficientsTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[ThicknessFunctionDataCoefficientsRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[ThicknessFunctionDataCoefficientsRow, _Mapping]]] = ...) -> None: ...

class ThicknessFunctionDataCoefficientsRow(_message.Message):
...
class ThicknessTimeDependentPropertiesAndChildItemsTable(_message.Message):
    __slots__ = ()
