...
class Line(_message.Message):
    ...
    nurbs_order: int
    nurbs_control_points_by_components: LineNurbsControlPointsByComponentsTable
    nurbs_control_points: LineNurbsControlPointsTable
    nurbs_knots: LineNurbsKnotsTable
    is_rotated: bool
    ...
    support: int
    mesh_refinement: int
    line_weld_assignment: LineLineWeldAssignmentTable
    has_line_welds: bool
    is_generated: bool
...
class LineNurbsControlPointsTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[LineNurbsControlPointsRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[LineNurbsControlPointsRow, _Mapping]]] = ...) -> None: ...

class LineNurbsControlPointsRow(_message.Message):
...
class LineNurbsKnotsTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[LineNurbsKnotsRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[LineNurbsKnotsRow, _Mapping]]] = ...) -> None: ...

class LineNurbsKnotsRow(_message.Message):
...
class LineLineWeldAssignmentTable(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[LineLineWeldAssignmentRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[LineLineWeldAssignmentRow, _Mapping]]] = ...) -> None: ...

class LineLineWeldAssignmentRow(_message.Message):
