...
from ..models.create_issue_response_milestone_milestone_state import (
...
class CreateIssueResponseMilestone(BaseModel):
    ...
    Attributes:
        ...
        state (Optional[CreateIssueResponseMilestoneMilestoneState]): The state of the milestone. Example: open.
    ...
    state: Optional[CreateIssueResponseMilestoneMilestoneState] = Field(
