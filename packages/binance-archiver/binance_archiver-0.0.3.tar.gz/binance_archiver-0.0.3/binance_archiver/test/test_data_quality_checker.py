...
class TestIndividualColumnChecker:
    ...
    def test_is_transaction_time_lower_or_equal_event_time_positive(self):
        ...
        assert IndividualColumnChecker.is_transaction_time_lower_or_equal_event_time_with_one_ms_tolerance(transaction_series, event_time_series) == True
    ...
    def test_is_transaction_time_lower_or_equal_event_time_negative(self):
        ...
        assert IndividualColumnChecker.is_transaction_time_lower_or_equal_event_time_with_one_ms_tolerance(transaction_series, event_time_series) == False
