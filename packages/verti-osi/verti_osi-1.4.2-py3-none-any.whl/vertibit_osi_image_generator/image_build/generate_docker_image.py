import typer
from src.vertibit_osi_image_generator.shared_aux.shared import delete_files
from src.vertibit_osi_image_generator.shared_aux.extract_and_run_image import run_docker_image
from src.vertibit_osi_image_generator.shared_aux.comand_runner import run_and_log_commands
...
def build_docker_image(daemon, image_name, container_file, build_context, run_generated_image="False", delete_generated_dockerfile="False", output=""):
    """
