from .javascript_config import generate_nodejs_start_and_install_commands, generate_js_package_config_requirements, scan_for_js_package_manager_to_use
from .python_config import generate_python_start_command
...
def main_docker_file_generator(language_info, images, source_directory, root_directory):
    if language_info['language'] == 'NodeJs':
        ...
        return generate_nodejs_dockerfile(dev_base_image=images['dev-base'], prod_base_image=images['prod-base'], package_manager_dir=package_directories,
                                          entry_point=start_and_installation_command['start_command'], install_command=start_and_installation_command['installation_command'], source_dir=source_directory)
