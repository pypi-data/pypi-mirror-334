...
class SDKAdapter:
    ...
    def __init__(self, api_key: str, agent_id: str, base_url: Optional[str] = None, organization_id: Optional[str] = None, should_reset_cache: Optional[bool] = False, with_metrics_report: Optional[bool] = False):
        """
    ...
    def add_task(self, input: str, files: Optional[List[str]] = None, use_worker: Optional[bool] = False, thread_id: Optional[str] = None):
        ...
        Here’s an improved AI Agent instruction to prevent excessive retries and redundant executions like in the screenshot:
