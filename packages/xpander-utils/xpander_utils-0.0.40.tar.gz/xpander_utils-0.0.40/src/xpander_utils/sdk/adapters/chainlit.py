...
class ChainlitAdapter(SDKAdapter):
    ...
    async def process_tool_calls(self, run_id: str, tool_calls: Dict[int, ChainlitToolCallWithLLMResponse], on_node_enter: Optional[Callable], on_node_error: Optional[Callable], agent_custom_functions: list[GraphItem] = [], local_tools: Dict[str, Callable] = None) -> str | None:
        """
        ...
        for raw_tool_call in tool_calls.values():
            ...
            if tool_agent_id:
                ...
                if sub_agent_node:
                    ...
                    current_step.id = sub_agent_node.item_id
            ...
            if is_sub_agent:
                if not is_sub_agent_root:
                    current_step.parent_id = self.agent.id
