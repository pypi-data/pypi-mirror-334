...
class ApplicationLoadBalancerDetectionProps:
    def __init__(
        ...
        *,
        ...
        :param fault_count_percent_threshold: (experimental) The percentage of faults for a single ALB to consider an AZ to be unhealthy, this should align with your availability goal. For example 1% or 5%, 0.01 or 0.05.
        ...
        :param availability_outlier_threshold: (experimental) The threshold for the outlier detection algorithm. Default: "This depends on the algorithm used. STATIC: 0.66."
        ...
        :param latency_outlier_threshold: (experimental) The threshold for the outlier detection algorithm. Default: "This depends on the algorithm used. STATIC: 0.66. Z_SCORE: 3."
...
class NatGatewayDetectionProps:
    def __init__(
        ...
        *,
        ...
        :param packet_loss_outlier_threshold: (experimental) The threshold used with the outlier calculation. Default: "This depends on the outlier algorithm. STATIC: 0.66. Z-SCORE: 3."
