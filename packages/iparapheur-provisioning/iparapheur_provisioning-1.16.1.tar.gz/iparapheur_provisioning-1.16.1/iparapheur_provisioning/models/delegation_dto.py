...
class DelegationDto(BaseModel):
    ...
    delegating_desk_id: Optional[StrictStr] = Field(default=None, alias="delegatingDeskId")
    delegating_desk: Optional[DeskRepresentation] = Field(default=None, alias="delegatingDesk")
    ...
    __properties: ClassVar[List[str]] = ["id", "substituteDeskId", "substituteDesk", "delegatingDeskId", "delegatingDesk", "typeId", "type", "subtypeId", "subtype", "start", "end"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of delegating_desk
        if self.delegating_desk:
            _dict['delegatingDesk'] = self.delegating_desk.to_dict()
        ...
        # set to None if delegating_desk (nullable) is None
        # and model_fields_set contains the field
        if self.delegating_desk is None and "delegating_desk" in self.model_fields_set:
            _dict['delegatingDesk'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "delegatingDeskId": obj.get("delegatingDeskId"),
            "delegatingDesk": DeskRepresentation.from_dict(obj["delegatingDesk"]) if obj.get("delegatingDesk") is not None else None,
