...
def main(): 
    ...
    parser.add_argument("-eo", "--exclude_orphans", action='store_true', help="Exclude orphan reactions from the gap-filling repository.")
    parser.add_argument("-fi", "--force_inclusion", metavar='', type=str, default='-',  help="Force the inclusion of the provided reactions (comma-separated IDs).")
