    ...
    def list_conversations(self, user_id: Optional[str] = None) -> List[ConversationSummary]:
        ...
        for conversation in self._conversations.values():
            ...
            summary = ConversationSummary(
                ...
                first_message_at=conversation.messages[0].timestamp if conversation.messages else conversation.created_at,
                last_message_at=conversation.messages[-1].timestamp if conversation.messages else conversation.updated_at
            )
