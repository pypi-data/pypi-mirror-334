    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                # FIXME: very ugly way to force the callable to load - subclass LazyCallable with a cleaner method just for that (or use another lazy import library)
                if klass.callable is None:
                    try:
                        klass()
                    except Exception:
                        """ignore, this is just to load .callable"""
                klass = klass.callable
