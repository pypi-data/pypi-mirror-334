...
class TestPaginatedProductTypeList(unittest.TestCase):
    """PaginatedProductTypeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductTypeList:
        """Test PaginatedProductTypeList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductTypeList`
        """
        model = PaginatedProductTypeList()
        if include_optional:
    ...
    def testPaginatedProductTypeList(self):
        """Test PaginatedProductTypeList"""
