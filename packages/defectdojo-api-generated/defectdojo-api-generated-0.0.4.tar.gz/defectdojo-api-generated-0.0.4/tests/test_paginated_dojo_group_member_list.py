...
class TestPaginatedDojoGroupMemberList(unittest.TestCase):
    """PaginatedDojoGroupMemberList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedDojoGroupMemberList:
        """Test PaginatedDojoGroupMemberList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedDojoGroupMemberList`
        """
        model = PaginatedDojoGroupMemberList()
        if include_optional:
    ...
    def testPaginatedDojoGroupMemberList(self):
        """Test PaginatedDojoGroupMemberList"""
