...
class TestPaginatedNotificationsList(unittest.TestCase):
    """PaginatedNotificationsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedNotificationsList:
        """Test PaginatedNotificationsList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedNotificationsList`
        """
        model = PaginatedNotificationsList()
        if include_optional:
            return PaginatedNotificationsList(
                ...
                results = [
                    defectdojo_api_generated.models.notifications.Notifications(
                        id = 56, 
                        product = 56, 
                        user = 56, 
                        product_type_added = [
    ...
    def testPaginatedNotificationsList(self):
        """Test PaginatedNotificationsList"""
