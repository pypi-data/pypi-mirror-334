...
class TestPaginatedJIRAProjectList(unittest.TestCase):
    """PaginatedJIRAProjectList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedJIRAProjectList:
        ...
        if include_optional:
            return PaginatedJIRAProjectList(
                ...
                results = [
                    defectdojo_api_generated.models.jira_project.JIRAProject(
                        id = 56, 
                        project_key = '', 
                        issue_template_dir = '', 
                        component = '', 
                        ...
                        product = 56, 
                        engagement = 56, 
                        prefetch = defectdojo_api_generated.models.jira_project_prefetch.JIRAProject_prefetch(
                            engagement = {
    ...
    def testPaginatedJIRAProjectList(self):
        """Test PaginatedJIRAProjectList"""
