...
class TestPaginatedUserContactInfoListPrefetch(unittest.TestCase):
    """PaginatedUserContactInfoListPrefetch unit test stubs"""
    ...
    def testPaginatedUserContactInfoListPrefetch(self):
        """Test PaginatedUserContactInfoListPrefetch"""
