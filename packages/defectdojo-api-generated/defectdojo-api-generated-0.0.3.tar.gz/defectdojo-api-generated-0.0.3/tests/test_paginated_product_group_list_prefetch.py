...
class TestPaginatedProductGroupListPrefetch(unittest.TestCase):
    """PaginatedProductGroupListPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductGroupListPrefetch:
        """Test PaginatedProductGroupListPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductGroupListPrefetch`
        """
        model = PaginatedProductGroupListPrefetch()
        if include_optional:
            return PaginatedProductGroupListPrefetch(
                group = {
    ...
    def testPaginatedProductGroupListPrefetch(self):
        """Test PaginatedProductGroupListPrefetch"""
