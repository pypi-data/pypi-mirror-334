...
class TestPaginatedProductTypeGroupListPrefetch(unittest.TestCase):
    """PaginatedProductTypeGroupListPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductTypeGroupListPrefetch:
        """Test PaginatedProductTypeGroupListPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductTypeGroupListPrefetch`
        """
        model = PaginatedProductTypeGroupListPrefetch()
        if include_optional:
            return PaginatedProductTypeGroupListPrefetch(
                group = {
    ...
    def testPaginatedProductTypeGroupListPrefetch(self):
        """Test PaginatedProductTypeGroupListPrefetch"""
