...
class TestPaginatedProductMemberListPrefetch(unittest.TestCase):
    """PaginatedProductMemberListPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductMemberListPrefetch:
        """Test PaginatedProductMemberListPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductMemberListPrefetch`
        """
        model = PaginatedProductMemberListPrefetch()
        if include_optional:
            return PaginatedProductMemberListPrefetch(
                product = {
    ...
    def testPaginatedProductMemberListPrefetch(self):
        """Test PaginatedProductMemberListPrefetch"""
