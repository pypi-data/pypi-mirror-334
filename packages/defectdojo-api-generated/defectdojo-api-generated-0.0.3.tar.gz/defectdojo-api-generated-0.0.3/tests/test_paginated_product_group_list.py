...
class TestPaginatedProductGroupList(unittest.TestCase):
    """PaginatedProductGroupList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductGroupList:
        """Test PaginatedProductGroupList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductGroupList`
        """
        model = PaginatedProductGroupList()
        if include_optional:
            return PaginatedProductGroupList(
                ...
                results = [
                    defectdojo_api_generated.models.product_group.ProductGroup(
                        id = 56, 
                        product = 56, 
                        group = 56, 
                        role = 56, 
    ...
    def testPaginatedProductGroupList(self):
        """Test PaginatedProductGroupList"""
