...
class TestPaginatedProductListPrefetch(unittest.TestCase):
    """PaginatedProductListPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductListPrefetch:
        """Test PaginatedProductListPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductListPrefetch`
        """
        model = PaginatedProductListPrefetch()
        if include_optional:
            return PaginatedProductListPrefetch(
                ...
                regulations = {
                    'key' : defectdojo_api_generated.models.regulation.Regulation(
                        id = 56, 
                        name = '', 
                        acronym = '', 
                        category = 'privacy', 
    ...
    def testPaginatedProductListPrefetch(self):
        """Test PaginatedProductListPrefetch"""
