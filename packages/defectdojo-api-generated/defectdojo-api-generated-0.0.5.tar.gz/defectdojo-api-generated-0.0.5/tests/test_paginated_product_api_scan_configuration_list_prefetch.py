...
class TestPaginatedProductAPIScanConfigurationListPrefetch(unittest.TestCase):
    """PaginatedProductAPIScanConfigurationListPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductAPIScanConfigurationListPrefetch:
        """Test PaginatedProductAPIScanConfigurationListPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductAPIScanConfigurationListPrefetch`
        """
        model = PaginatedProductAPIScanConfigurationListPrefetch()
        if include_optional:
            return PaginatedProductAPIScanConfigurationListPrefetch(
                product = {
    ...
    def testPaginatedProductAPIScanConfigurationListPrefetch(self):
        """Test PaginatedProductAPIScanConfigurationListPrefetch"""
