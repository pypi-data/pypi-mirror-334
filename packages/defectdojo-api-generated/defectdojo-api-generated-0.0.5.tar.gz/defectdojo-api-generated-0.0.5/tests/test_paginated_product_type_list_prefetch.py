...
class TestPaginatedProductTypeListPrefetch(unittest.TestCase):
    """PaginatedProductTypeListPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedProductTypeListPrefetch:
        """Test PaginatedProductTypeListPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedProductTypeListPrefetch`
        """
        model = PaginatedProductTypeListPrefetch()
        if include_optional:
            return PaginatedProductTypeListPrefetch(
    ...
    def testPaginatedProductTypeListPrefetch(self):
        """Test PaginatedProductTypeListPrefetch"""
