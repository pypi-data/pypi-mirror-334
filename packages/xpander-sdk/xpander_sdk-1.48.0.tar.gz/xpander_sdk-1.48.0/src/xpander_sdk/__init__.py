...
class Agent(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Agent"):
    ...
    def report_execution_metrics(
        ...
        return typing.cast(None, jsii.invoke(self, "reportExecutionMetrics", [llm_tokens, ai_model]))
    ...
    def report_llm_usage(
        ...
        if __debug__:
            ...
            check_type(argname="argument llm_provider", value=llm_provider, expected_type=type_hints["llm_provider"])
        return typing.cast(None, jsii.invoke(self, "reportLlmUsage", [llm_response, llm_inference_duration, llm_provider]))
...
class ExecutionMetrics(
    ...
    def source(self) -> SourceNodeType:
        return typing.cast(SourceNodeType, jsii.get(self, "source"))

    @source.setter
    def source(self, value: SourceNodeType) -> None:
        if __debug__:
...
class LLMMetrics(
    ...
    def source_node_type(self, value: SourceNodeType) -> None:
        if __debug__:
