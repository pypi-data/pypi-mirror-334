...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, tls_validation=None, sock_connect_timeout=None, rate_limit=None, pulp_created=None, ca_cert=None, name=None, pulp_labels=None, proxy_url=None, sock_read_timeout=None, max_retries=None, pulp_last_updated=None, connect_timeout=None, headers=None, url=None, client_cert=None, total_timeout=None, hidden_fields=None, download_concurrency=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
