...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, password=None, sock_connect_timeout=None, rate_limit=None, ca_cert=None, name=None, pulp_labels=None, proxy_url=None, username=None, sock_read_timeout=None, max_retries=None, connect_timeout=None, headers=None, proxy_password=None, url=None, client_cert=None, proxy_username=None, total_timeout=None, client_key=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
