...
** Invoked class's static method.
    ...
    PlatfSitesActivate_FPs.fps_asCsParamsAdd(csParams,)


####+BEGIN: bx:dblock:python:class :className "PlatfSitesActivate_FPs" :superClass "bpoFpsCls.BpoFpsCls" :comment "" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /PlatfSitesActivate_FPs/ bpoFpsCls.BpoFpsCls  [[elisp:(org-cycle)][| ]]
#+end_org """
class PlatfSitesActivate_FPs(bpoFpsCls.BpoFpsCls):
####+END:
    """
...
####+END:
            self,
            bpoId: str = "",
            bpoFpsRelPath: os.PathLike = pathlib.Path("platfSitesActivate_fps",),
            fpBase: os.PathLike = pathlib.Path("_null_",),
    ):
        """ #+begin_org
** fpBase is used with getattr of bpoFpsRelPath is a specific repo -- platfSitesActivate_fps
        #+end_org """
...
####+END:
        ...
        # return csParams
        csParams.parDictAdd(
            parName='platfSitesActivate_primary',
            parDescription="BPO Id of Primary Site",
            fileParName="primary",
            fileParInit="pis_superSiteNeda",
            argparseLongOpt='--platfSitesActivate_',
        )
        csParams.parDictAdd(
            parName='platfSitesActivate_others',
            parDescription="BPO Ids of Other Sites",
            fileParInit="[]",
            fileParName="others",
            argparseLongOpt='--platfSitesActivate_others',
        )
        return csParams
...
####+END:
        ...
        """
        self._cmndParPrefix = "platfSitesActivate_"
