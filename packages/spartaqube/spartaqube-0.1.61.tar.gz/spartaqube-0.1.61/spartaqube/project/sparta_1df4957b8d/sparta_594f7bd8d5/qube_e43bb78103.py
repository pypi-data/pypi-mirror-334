...
from project.sparta_aac227c3fb.sparta_e0ad6143e8.qube_cb17db70d7 import convert_to_dataframe
...
class WssConnectorWS(WebsocketConsumer):
	...
	def init_socket(B,json_data):
		...
		if D:
			E=A['connector_id'];C=qube_2041d0ee11.sparta_ff545a25da(E,B.user)
