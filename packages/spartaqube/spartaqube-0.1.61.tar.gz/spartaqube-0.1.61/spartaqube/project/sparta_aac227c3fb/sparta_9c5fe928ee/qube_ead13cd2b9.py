...
def sparta_f037c30426(user_obj):
	B=user_obj
	...
	return A
def sparta_15519d03c4(json_data,user_obj):
...
def sparta_058fbe6787(json_data,user_obj):
...
def sparta_490345f651(json_data,user_obj):
	...
	return{_C:1}
def sparta_ba7a68d549(json_data,user_obj):
