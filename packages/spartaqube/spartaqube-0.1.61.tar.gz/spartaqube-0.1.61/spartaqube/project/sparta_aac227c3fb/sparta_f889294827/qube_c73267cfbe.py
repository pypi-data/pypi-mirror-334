...
from project.sparta_1df4957b8d.qube_df0639cdfa import timeout
from project.sparta_aac227c3fb.sparta_e0ad6143e8.qube_cb17db70d7 import convert_to_dataframe,sparta_9a9cd2cf6a
from project.sparta_aac227c3fb.sparta_e0ad6143e8.qube_533d926758 import sparta_978905e1c8
from project.logger_config import logger
B_DEBUG=_B
SEND_INTERVAL=.8
def sparta_6835487c32():return conf_settings.DEFAULT_TIMEOUT
def sparta_124873d830(file_path=_A,text=_A):
	A=file_path
...
class IPythonKernel:
	...
	async def initialize_kernel(B):
		...
		A+='django.setup()\n';D=sparta_1164cc3e5c()['project'];E=sparta_1164cc3e5c()['project/core/api'];A+=f'sys.path.insert(0, r"{str(D)}")\n';A+=f'sys.path.insert(0, r"{str(E)}")\n';A+=f'os.environ["api_key"] = "{B.api_key}"\n'
	...
	async def activate_venv(C,venv_name):
		def D():B=sparta_978905e1c8();A=os.path.join(B,'sq_venv');A=os.path.normpath(A);os.makedirs(A,exist_ok=_C);return A
