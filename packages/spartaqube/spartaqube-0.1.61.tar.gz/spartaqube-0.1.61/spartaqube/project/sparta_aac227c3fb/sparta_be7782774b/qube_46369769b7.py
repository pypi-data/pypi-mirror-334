...
def sparta_2d8a647bbf(json_data,userObj):
	B=json_data[_C]
	if int(B)==1:
	...
	try:G,H=sparta_dc6d265250(A,B);D={_A:1,_D:H,_E:G,_B:A}
	except:D={_A:-1,_F:_G}
	return D
def sparta_1a8d28bd86(json_data,userObj):
	A=json_data
	try:D=A[_B];E=A[_C];B=os.path.dirname(D);F,G=sparta_dc6d265250(B,E);C={_A:1,_D:G,_E:F,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_539211d969(json_data,userObj):
	A=json_data
	try:B=A[_B];D=A[_C];E,F=sparta_dc6d265250(B,D);C={_A:1,_D:F,_E:E,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_dc6d265250(currentPath,typeexplorer=None):
...
def sparta_398ab4c16e(currentPath):
