...
from project.sparta_c86ac10c1e.sparta_45f849ee34.qube_9cbbe19431 import convert_to_dataframe
...
class WssConnectorWS(WebsocketConsumer):
	...
	def init_socket(B,json_data):
		...
		if D:
			E=A['connector_id'];C=qube_af72c7c492.sparta_32379c29a3(E,B.user)
