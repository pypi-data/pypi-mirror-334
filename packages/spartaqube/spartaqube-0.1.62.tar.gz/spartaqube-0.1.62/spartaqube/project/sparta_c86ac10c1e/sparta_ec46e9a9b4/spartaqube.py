...
from project.sparta_c86ac10c1e.sparta_ec46e9a9b4.qube_6e3dd19911 import sparta_03a40eae6d
from project.sparta_c86ac10c1e.sparta_45f849ee34.qube_9cbbe19431 import convert_to_dataframe,convert_dataframe_to_json
...
class Spartaqube:
	...
	def get_widget_data(A,widget_id):B={_D:'get_widget_data',_B:widget_id};return sparta_03a40eae6d(B,A.user_obj)
	def sparta_871b803299(A,widget_id):B={_D:'has_widget_id',_B:widget_id};return sparta_03a40eae6d(B,A.user_obj)
	...
	def plot(V,*W,**A):
		...
		if E is _A:
			L=sparta_96781f896a(b_return_type_id=_C)
	...
	def get_connector_tables(A,connector_id):B={_D:'get_connector_tables',_H:connector_id};return sparta_03a40eae6d(B,A.user_obj)
	def get_data_from_connector(I,connector_id,table=_A,sql_query=_A,output_format=_A,dynamic_inputs=_A):
		...
		A['dynamic_inputs']=H;B=sparta_03a40eae6d(A,I.user_obj);C=False
		if F is _A:C=_C
		...
		return B
	def apply_method(B,method_name,*D,**C):A=C;A[_D]=method_name;return sparta_03a40eae6d(A,B.user_obj)
