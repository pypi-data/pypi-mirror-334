...
from project.sparta_3d2a895074.qube_aa03ab87fe import timeout
from project.sparta_c86ac10c1e.sparta_45f849ee34.qube_9cbbe19431 import convert_to_dataframe,sparta_26b96afe1f
from project.sparta_c86ac10c1e.sparta_45f849ee34.qube_8460cefce9 import sparta_90ad52a9f3
from project.logger_config import logger
B_DEBUG=_B
SEND_INTERVAL=.8
def sparta_f9675c53fb():return conf_settings.DEFAULT_TIMEOUT
def sparta_29cae94f0c(file_path=_A,text=_A):
	A=file_path
...
class IPythonKernel:
	...
	async def initialize_kernel(B):
		...
		A+='django.setup()\n';D=sparta_58b54fa947()['project'];E=sparta_58b54fa947()['project/core/api'];A+=f'sys.path.insert(0, r"{str(D)}")\n';A+=f'sys.path.insert(0, r"{str(E)}")\n';A+=f'os.environ["api_key"] = "{B.api_key}"\n'
	...
	async def activate_venv(C,venv_name):
		def D():B=sparta_90ad52a9f3();A=os.path.join(B,'sq_venv');A=os.path.normpath(A);os.makedirs(A,exist_ok=_C);return A
