...
class WebcamWorker(QThread):
    frameCaptured = Signal(np.ndarray)  # emits raw frame as a NumPy array
...
class PvWebcam(QWidget):
    ...
    def update_frame(self, frame: np.ndarray):
        """Slot to update the widget when a new frame is captured."""
    ...
    def frame_processor(self, value):
        self._frame_processor = value
