...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, connection_list=None, is_housed=None, assigned_item=None, technical_system_list=None, alternate_name=None, catalog_item=None, inventory_item=None, local_vars_configuration=None):  # noqa: E501
