...
Things the transpiler will generally not handle for you:
...
When migrating cyber analytics out of Splunk, you are likely to re-implement normalization targeting OCSF, but
