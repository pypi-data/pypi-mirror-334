use crate::ast::{Call, Expr, Field, ParsedCommandOptions};
...
use crate::parser::{field, field_in, logical_expression, space_separated_list1, token, ws};
use crate::python::*;
use nom::branch::alt;
...
mod tests {
    use super::*;
    use crate::ast;
    use crate::ast::TimeSpan;
    use crate::parser::logical_expression_term;
    ...
    fn test_tstats_2() {
        ...
        assert_eq!(
            all_consuming(TStatsParser::parse).parse(query),
            Ok((
                "",
                TStatsCommand {
                    prestats: false,
