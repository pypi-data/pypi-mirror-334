use crate::ast::{Field, ParsedCommandOptions, Pipeline};
use crate::commands::base::{SplCommand, SplCommandOptions};
use crate::parser::{field_list1, sub_search};
use crate::python::*;
...
impl SplCommand<JoinCommand> for JoinParser {
    ...
    fn parse_body(input: &str) -> IResult<&str, JoinCommand> {
        map(
            (Self::Options::match_options, field_list1, sub_search),
                ...
                JoinCommand {
                    ...
                    sub_search: ast::Pipeline {
                        commands: vec![SearchCommand {
                            expr: ast::StrValue::from("vendors").into()
                        }
                        .into()],
                    }
                }
        ...
        assert_eq!(
            ...
            Ok((
                ...
                JoinCommand {
                    ...
                    sub_search: Pipeline {
                        commands: vec![
                            crate::commands::cmd::t_stats::TStatsCommand {
                                prestats: false,
                                local: false,
                                append: false,
                            ...
                            .into(),
                            crate::commands::cmd::rename::RenameCommand {
                                alias: vec![_alias("*", ast::Field::from("Filesystem.*")),],
                            }
                            .into(),
                            crate::commands::cmd::fields::FieldsCommand {
                                remove_fields: false,
                                fields: vec![
