use crate::ast::*;
use crate::base::{PysparkTranspileContext, RuntimeSelection};
...
mod tests {
    ...
    #[rstest]
    fn test_field(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
    ...
    #[rstest]
    fn test_binary_op(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
    ...
    #[rstest]
    fn test_field_in_0(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
    ...
    #[rstest]
    fn test_field_in_1_wildcard(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
            Expr::Column(column_like!([col("c")].ilike([py_lit("abc%")]))),
            ast::Expr::FieldIn(ast::FieldIn {
                field: "c".to_string(),
    ...
    #[rstest]
    fn test_field_in_1_exact(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
            Expr::Column(column_like!([col("c")] == [lit("abc")])),
            ast::Expr::FieldIn(ast::FieldIn {
                field: "c".to_string(),
    ...
    #[rstest]
    fn test_field_in_2(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
            Expr::Column(column_like!(
                [[col("c")] == [lit("abc")]] | [[col("c")].ilike([py_lit("abc%")])]
            )),
            ast::Expr::FieldIn(ast::FieldIn {
                field: "c".to_string(),
                exprs: vec![
    ...
    #[rstest]
    fn test_field_in_3(#[from(crate::base::test::ctx_bare)] ctx: PysparkTranspileContext) {
        assert_eq!(
            Expr::Column(column_like!(
                [[[col("c")] == [lit("abc")]] | [[col("c")].ilike([py_lit("abc%")])]]
                    | [[col("c")] == [lit("xyz")]]
