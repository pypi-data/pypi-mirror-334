...
class OpenAIProvider(AIProvider):
    ...
    def call_ai(self, messages, temperature, max_tokens, model="gpt-4o", **kwargs):
        try:
    ...
    async def call_ai_async(
        self, messages, temperature, max_tokens, model="gpt-4o", **kwargs
    ):
        try:
...
class GeminiProvider(AIProvider):
    supported_models = [
        ...
        "genai/models/learnlm-1.5-pro-experimental,",
    ...
    def call_ai(
        self, messages, temperature, max_tokens, model="gemini-2.0-flash-exp", **kwargs
    ):
        try:
