...
@shell.define
class Peaks2Fixel(specs.ShellDef["Peaks2Fixel.Outputs"]):
    ...
    # Options
    dataname: str | None = shell.arg(
        default=None,
        argstr="-dataname",
        help="""the name of the output fixel data file encoding peak amplitudes""",
    )
    ...
    class Outputs(specs.ShellOutputs):
        fixels: Directory = shell.outarg(
            argstr="",
            position=2,
            path_template="fixels",
