...
@shell.define
class Voxel2Mesh(specs.ShellDef["Voxel2Mesh.Outputs"]):
    ...
    blocky: bool = shell.arg(
        default=False,
        argstr="-blocky",
        help="""generate a 'blocky' mesh that precisely represents the voxel edges""",
    )
    threshold: float | None = shell.arg(
        default=None,
        argstr="-threshold",
        help="""manually set the intensity threshold for the Marching Cubes algorithm""",
    )
