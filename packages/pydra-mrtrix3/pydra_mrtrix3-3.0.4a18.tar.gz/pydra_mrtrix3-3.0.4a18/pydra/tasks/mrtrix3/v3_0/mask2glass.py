...
class Mask2Glass(specs.ShellDef["Mask2Glass.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2024 the MRtrix3 contributors.
    ...
    dilate: int | None = shell.arg(
        help="Provide number of iterations for dilation step; default = 2",
        argstr="-dilate",
        default=None,
    )
    scale: float | None = shell.arg(
        help="Provide resolution upscaling value; default = 2.0",
        argstr="-scale",
        default=None,
    )
    smooth: float | None = shell.arg(
        help="Provide standard deviation of smoothing (in mm); default = 1.0",
        argstr="-smooth",
        default=None,
    )
