...
@shell.define
class Dwi2Mask_Fslbet(specs.ShellDef["Dwi2Mask_Fslbet.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2024 the MRtrix3 contributors.
    ...
    bet_f: float | None = shell.arg(
        help="Fractional intensity threshold (0->1); smaller values give larger brain outline estimates",
        argstr="-bet_f",
        default=None,
    )
    bet_g: float | None = shell.arg(
    ...
    bet_c: typing.List[float] | None = shell.arg(
        help="Centre-of-gravity (voxels not mm) of initial mesh surface",
        argstr="-bet_c",
        default=None,
    )
    bet_r: float | None = shell.arg(
        help="Head radius (mm not voxels); initial surface sphere is set to half of this",
        argstr="-bet_r",
        default=None,
    )
    rescale: bool = shell.arg(
        help="Rescale voxel size provided to BET to 1mm isotropic; can improve results for rodent data",
        argstr="-rescale",
        default=False,
    )
