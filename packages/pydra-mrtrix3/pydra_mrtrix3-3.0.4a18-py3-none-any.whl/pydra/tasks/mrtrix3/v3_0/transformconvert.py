...
@shell.define
class TransformConvert(specs.ShellDef["TransformConvert.Outputs"]):
    ...
    # Arguments
    input: MultiInputObj[ty.Any] = shell.arg(
        argstr="",
        position=1,
    ...
    operation: str = shell.arg(
        argstr="",
        position=2,
        help="""the operation to perform; one of: flirt_import, itk_import""",
        allowed_values=["flirt_import", "itk_import"],
    )
