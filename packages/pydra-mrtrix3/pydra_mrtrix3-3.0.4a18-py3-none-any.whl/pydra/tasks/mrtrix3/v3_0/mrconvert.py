...
@shell.define
class MrConvert(specs.ShellDef["MrConvert.Outputs"]):
    ...
    coord: MultiInputObj[tuple[int, int]] | None = shell.arg(
        default=None,
        argstr="-coord",
    ...
    scaling: list[float] | None = shell.arg(
        default=None,
        argstr="-scaling",
    ...
    clear_property: MultiInputObj[str] | None = shell.arg(
        default=None,
        argstr="-clear_property",
        help="""remove the specified key from the image header altogether.""",
    )
    set_property: MultiInputObj[tuple[str, str]] | None = shell.arg(
        default=None,
        argstr="-set_property",
        help="""set the value of the specified key in the image header.""",
        sep=" ",
    )
    append_property: MultiInputObj[tuple[str, str]] | None = shell.arg(
        default=None,
    ...
    class Outputs(specs.ShellOutputs):
        ...
        json_export: File | bool | None = shell.outarg(
            default=None,
            argstr="-json_export",
