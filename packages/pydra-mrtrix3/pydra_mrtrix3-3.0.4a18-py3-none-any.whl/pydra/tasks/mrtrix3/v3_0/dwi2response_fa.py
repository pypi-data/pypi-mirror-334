...
@shell.define(xor=[["number", "threshold", None]])
class Dwi2Response_Fa(specs.ShellDef["Dwi2Response_Fa.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2024 the MRtrix3 contributors.
    ...
    erode: int | None = shell.arg(
        help="Number of brain mask erosion steps to apply prior to threshold (not used if mask is provided manually)",
        argstr="-erode",
        default=None,
    )
    ...
    threshold: float | None = shell.arg(
        help="Apply a hard FA threshold, rather than selecting the top voxels",
        argstr="-threshold",
        default=None,
    )
