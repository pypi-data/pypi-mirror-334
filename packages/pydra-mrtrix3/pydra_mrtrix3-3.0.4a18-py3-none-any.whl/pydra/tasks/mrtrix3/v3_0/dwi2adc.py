...
@shell.define
class Dwi2Adc(specs.ShellDef["Dwi2Adc.Outputs"]):
    ...
    ivim: bool = shell.arg(
        default=False,
        argstr="-ivim",
        help="""also estimate IVIM parameters in 2-stage fit.""",
    )
    cutoff: int | None = shell.arg(
        default=None,
        argstr="-cutoff",
        help="""minimum b-value for ADC estimation in IVIM fit (default = 120 s/mm^2).""",
    )
