...
-  **``init(ignored=IGNORED,brief_global_var=True,maxlength=150)``**:
   启用所有异常（包括标准库的异常，和继承自标准库的自定义异常类）的自动捕获堆栈，以及堆栈输出。\ **（推荐使用）**
...
.. |Stars| image:: https://img.shields.io/github/stars/qfcy/PyStackSnapshot
   :target: https://img.shields.io/github/stars/qfcy/PyStackSnapshot
.. |GitHub release| image:: https://img.shields.io/github/v/release/qfcy/PyStackSnapshot
   :target: https://github.com/qfcy/PyStackSnapshot/releases/latest
.. |License: MIT| image:: https://img.shields.io/github/license/qfcy/PyStackSnapshot
   :target: https://github.com/qfcy/PyStackSnapshot/blob/main/LICENSE
