...
import flet_cli.commands.build3
import flet_cli.commands.build2
...
def main():
    ...
    flet_cli.commands.build3.Command.register_to(sp, "build3")
    flet_cli.commands.build2.Command.register_to(sp, "build2")
