...
version_line = open("sensirion_i2c_sfa3x/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sfa3x',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SFA3X sensor family',
    license='BSD',
    keywords="""Sensirion SFA3X
        I2C
        SFA3X""",
    project_urls={
        "Documentation": "https://sensirion.github.io/python-i2c-sfa3x",
        "Repository": "https://github.com/Sensirion/python-i2c-sfa3x",
        "Changelog": "https://github.com/Sensirion/python-i2c-sfa3x/blob/master/CHANGELOG.md",
    },
