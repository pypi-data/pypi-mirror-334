...
def pydantic_to_markdown_table(model_class: Type[BaseModel]) -> str:
    """
    Convert a Pydantic model class to a markdown table.
    
    Args:
        model_class: A Pydantic model class (subclass of BaseModel)
        
    Returns:
        A markdown table string with columns for property name, type, default value, and description
    """
