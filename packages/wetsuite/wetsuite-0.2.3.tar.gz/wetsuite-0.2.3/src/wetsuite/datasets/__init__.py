...
# _index_data = {
#     ('rechtspraaknl-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/X0hf1KCE4eHX0an/download'),
#     ('cvdr-mostrecent-html.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/prjXbbgrcC8czrO/download'),
#     ('cvdr-mostrecent-xml.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/VSfgkryVEQL0EOV/download'),
#     ('cvdr-mostrecent-text.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/iFfd3EL3yttDEa0/download'),
#     ('rechtspraaknl-sample-xml.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/nk7juhzrI5U54AH/download'),
#     ('parliament-sample-xml.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/d1EVaOyyJDNqxcB/download'),
#     ('bwb-mostrecent-xml.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/dAQdpbooCaltH7m/download'),
#     ('eurlex-judg-nl-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/IbQ6LsnYk7BbgoY/download'),
#     ('eurlex-reg-nl-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/blmzCoXPDAw7niZ/download'),
#     ('tweedekamer-kamervragen-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/ckqn8OB1XQP8eYi/download'),
#     ('bwb-mostrecent-text.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/2czhIfccv8tWr83/download'),
#     ('raadvanstate-adviezen-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/I4JLNLIKpnPBd7l/download'),
#     ('eurlex-dir-nl-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/AQ4Bs93Y80Z6EHz/download'),
#     ('woo_besluiten_docs_text.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/9qScpK0hlycdKz0/download'),
#     ('internetconsultaties-partial-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/B4w3DywmBOnxXXE/download'),
#     ('bwb-mostrecent-meta-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/bMlXm8TeU346eLL/download'),
#     ('kansspelautoriteit-sancties-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/Hl75ce7IwZkM4Kc/download'),
#     ('wetnamen.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/wvkvPqV7uWxisEw/download'),
#     ('woo_besluiten_meta.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/JzwP5KTCnaUHBz6/download'),
#     ('tweedekamer-fractie-membership-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/rtRQb6GUYNNTCf0/download'),
#     ('tweedekamer-fracties-struc.db.xz', 'https://universiteitleiden.data.surfsara.nl/index.php/s/TsdYXzZEzNKJGiO/download'),
# }
