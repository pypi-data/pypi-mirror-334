...
class IntegrationParameters:
    ...
    jira: JiraParams | None = None


class TaskManagementIntegrationType(StrEnum):
    JIRA = "JIRA"


@dataclass(kw_only=True)
class CreateTaskManagementIntegrationInput:
...
@dataclass(kw_only=True)
class CreateTaskManagementIntegrationOutput:

    integration_id: str | None = None


@dataclass(kw_only=True)
class FindTaskManagementIntegrationsInput:

    organisation_id: int | None = None


class TaskManagementIntegrationStatus(StrEnum):
    CONNECTED = "CONNECTED"
    VALIDATION_FAILED = "VALIDATION_FAILED"


@dataclass(kw_only=True)
class FindTaskManagementIntegrationsOutput:
...
@dataclass(kw_only=True)
class RemoveTaskManagementIntegrationInput:
...
@dataclass
class RemoveTaskManagementIntegrationOutput:
    pass


@dataclass(kw_only=True)
class ValidateJiraIntegrationInput:
...
@dataclass(kw_only=True)
class ValidateJiraIntegrationOutput:
