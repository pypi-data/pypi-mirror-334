...
def main():
    ...
    parser.add_argument('--output-format', dest='output_format', default='residue_multi', help='Specify output format')
    parser.add_argument("--no-smoothing", dest='smoothing', action="store_false", help="Turn off the smoothing function")
    parser.add_argument("--no-remove-short-regions", dest='remove_short_regions', action="store_false", help="Turn off the ability to cut short prediction areas")
