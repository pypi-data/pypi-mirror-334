...
class CustomJSONEncoder(json.JSONEncoder):
    def default(self, obj):
        if hasattr(obj, "get_secret_value") and callable(getattr(obj, "get_secret_value")):
...
class DatabaseManager:
    ...
    def __init__(self, engine_uri: str, base_dir: Optional[Union[str, Path]] = None) -> None:
        ...
        self.engine = create_engine(engine_uri, connect_args=connection_args, json_serializer=lambda obj: json.dumps(obj, cls=CustomJSONEncoder))
