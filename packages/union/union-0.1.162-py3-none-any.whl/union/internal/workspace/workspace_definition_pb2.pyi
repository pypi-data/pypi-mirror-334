...
class WorkspaceDefinitionSpec(_message.Message):
    __slots__ = ["short_description", "created_at", "updated_at", "task_id", "state", "task_spec", "resources", "extended_resources", "ttl_seconds", "security_context", "python_environment", "conda_environment", "on_startup"]
...
class WorkspaceDefinitionEntity(_message.Message):
    __slots__ = ["id", "state", "short_description"]
    ID_FIELD_NUMBER: _ClassVar[int]
    STATE_FIELD_NUMBER: _ClassVar[int]
    SHORT_DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    state: WorkspaceDefinitionState
    short_description: str
    def __init__(self, id: _Optional[_Union[WorkspaceDefinitionEntityId, _Mapping]] = ..., state: _Optional[_Union[WorkspaceDefinitionState, str]] = ..., short_description: _Optional[str] = ...) -> None: ...
