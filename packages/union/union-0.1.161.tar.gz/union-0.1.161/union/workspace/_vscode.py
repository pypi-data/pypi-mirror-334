...
def configure_code_server_config():
    ...
    if not CODE_SERVER_SETTINGS_PATH.exists():
        logger.info(f"Creating code server settings directory {CODE_SERVER_SETTINGS_PATH}")
        CODE_SERVER_SETTINGS_PATH.parent.mkdir(parents=True)
