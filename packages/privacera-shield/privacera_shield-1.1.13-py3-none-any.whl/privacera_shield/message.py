...
class ErrorMessage(BaseMessage):
    ...
    SHIELD_SERVER_AUTHORIZATION_FAILED = 400020, ("Shield server authorization request failed with status code={"
                                                  "response_status}, body={response_data}")
    SHIELD_SERVER_GET_FILTER_EXPRESSION_FAILED = 400021, ("Shield server get filter expression request failed with "
                                                          "status code={response_status}, body={response_data}")
    SHIELD_SERVER_LOG_STREAM_ACCESS_AUDIT_FAILED = 400022, ("Shield server log stream access audit request failed with "
                                                            "status code={response_status}, body={response_data}")
