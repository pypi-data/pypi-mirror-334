...
class BullinvQuote:
    @staticmethod
    def get_data(ticker, start_date=None, end_date=None, limit=1000, include_indicators=False):
    ...
    @staticmethod
    def stock_screener(conditions: list[dict], include_columns: list[str] = ["*"], limit: int = 100) -> pd.DataFrame:
        # 构建完整的查询条件
        where_clauses = []
        join_needed = False
        ...
        if join_needed:
            ...
            ON t1.ticker = t2.ticker AND t2.date = t1.date - INTERVAL 1 DAY
