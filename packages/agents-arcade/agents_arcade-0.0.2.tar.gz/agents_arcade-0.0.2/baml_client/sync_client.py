...
class BamlStreamClient:
    ...
    def BestRestaurant(
        ...
        query: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[Optional[Union[partial_types.Reply, partial_types.OauthRequired]], Union[types.Reply, types.OauthRequired]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[Optional[Union[partial_types.Reply, partial_types.OauthRequired]], Union[types.Reply, types.OauthRequired]](
        raw,
