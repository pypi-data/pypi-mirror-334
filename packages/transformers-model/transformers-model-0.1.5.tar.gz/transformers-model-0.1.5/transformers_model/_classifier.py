...
class TokenClassifier(nn.Module):
    ...
    def __init__(self, backbone, classifier, num_train_layers=0):
        ...
        self.device = None  # 初始化设备属性，用于后续可能的设备分配
    ...
    def fit(self, input_ids: torch.Tensor, attention_mask: torch.Tensor, labels: torch.Tensor, 
...
class AutoCNNTokenClassifier(TokenClassifier):
    ...
    def __init__(self, pretrained_path, num_classes: int, num_train_layers=0, config = None, **kwargs):
        """
        初始化模型。
...
class BertCNNTokenClassifier(AutoCNNTokenClassifier):
    ...
    def __init__(self, pretrained_path, num_classes, num_train_layers=0, **kwargs):
        ...
        super().__init__(pretrained_path, num_classes, num_train_layers, config, **kwargs)
...
class AutoRNNAttentionTokenClassifier(TokenClassifier):
    ...
    def __init__(self, pretrained_path, num_classes, num_train_layers=0, config = None, **kwargs):
        """
        初始化模型。
...
class TextClassifier(TokenClassifier):
    ...
    def __init__(self, pretrained_path, backbone, classifier, num_train_layers=0, 
                 max_length: int = 512, padding: Union[bool, str, PaddingStrategy] = True, truncation=True, 
...
class AutoCNNTextClassifier(TextClassifier):
    ...
    def __init__(self, pretrained_path, num_classes, num_train_layers=0, max_length: int = 512,   
        ...
        **kwargs: 其他传递给分类器TextCNN的参数。
        ...
        classifier = TextCNN(embed_dim=config.hidden_size, out_features=num_classes, **kwargs)
        # 调用父类的初始化方法，初始化整个模型
        super().__init__(pretrained_path, backbone, classifier, num_train_layers, max_length, padding, truncation, 
...
class BertCNNTextClassifier(AutoCNNTextClassifier):
    ...
    def __init__(self, pretrained_path, num_classes, num_train_layers=0, max_length: int = 512,   
        ...
        config = BertConfig.from_pretrained(pretrained_path)
        super().__init__(pretrained_path, num_classes, num_train_layers, max_length, padding, truncation, 
