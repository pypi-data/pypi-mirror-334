...
async def run_test_function(
    ...
    # Get the current event loop and apply nest_asyncio to handle nested loops
    ...
    if is_async:
        ...
        if timeout is not None:
            # Run in executor with timeout to properly enforce timeouts
            ...
            # No timeout specified, we can call directly
            try:
