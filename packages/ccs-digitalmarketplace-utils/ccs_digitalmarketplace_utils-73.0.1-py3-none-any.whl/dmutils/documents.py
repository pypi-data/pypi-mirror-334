...
def upload_document_for_list_multiquestion(
    uploader,
    upload_type,
    documents_url,
    service,
    ...
    file_path = generate_file_name_for_list_multiquestion(
        service['frameworkSlug'],
        upload_type,
        service['supplierId'],
        item_number,
...
def upload_declaration_documents_for_list_multiquestion(
    uploader,
    upload_type,
    documents_url,
    request_files,
    ...
    for field, contents in files.items():
        ...
        url = upload_document_for_list_multiquestion(
            uploader,
            upload_type,
            documents_url,
            {
...
def generate_file_name_for_list_multiquestion(
    framework_slug,
    upload_type,
    supplier_id,
    item_number,
