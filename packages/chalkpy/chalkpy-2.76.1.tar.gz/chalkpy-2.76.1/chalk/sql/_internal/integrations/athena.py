...
class AthenaSourceImpl(BaseSQLSource):
    ...
    def __init__(
        ...
        *,
        ...
        self.work_group = work_group or load_integration_variable(integration_name=name, name="ATHENA_WORK_GROUP")
    ...
    def _execute_query_efficient(
        ...
        with safe_trace("athena.execute_query_efficient"):
            ...
            with self._pyathena_connection.cursor() as cursor:
                ...
                objects_list_response = self.s3_boto_client.list_objects_v2(Bucket=bucket_name, Prefix=remaining_prefix)
    ...
    def _download_worker(
        ...
        try:
            while True:
                ...
                if as_arrow is None:
                    as_arrow = x.to_arrow(self.s3_filesystem)
