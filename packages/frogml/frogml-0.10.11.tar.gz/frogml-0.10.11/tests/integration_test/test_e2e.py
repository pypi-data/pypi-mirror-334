...
def test_e2e_catboost(
    ...
    full_code_dir = given_full_path_to_file(file_name="../../../tests/frogml/catboost")
...
def test_e2e_pytorch(
    ...
    properties = {"key": "value"}
    full_code_dir = given_full_path_to_file(file_name="../../../tests/frogml/pytorch")
    repository = repository_in_project
    expected_runtime_version = given_runtime_version
...
def test_e2e_scikit_learn(
    ...
    properties = {"key": "value"}
    full_code_dir = given_full_path_to_file(
        file_name="../../../tests/frogml/scikit_learn"
    )
    repository = repository_in_project
    expected_runtime_version = given_runtime_version
...
def test_e2e_python_model(
    ...
    properties = {"key": "value"}
    full_code_dir = given_full_path_to_file(file_name="../../../tests/frogml/python")
...
def test_e2e_huggingface(
    ...
    properties = {"key": "value"}
    full_code_dir = given_full_path_to_file(
        file_name="../../../tests/frogml/huggingface"
    )
    dependencies = ["catboost==0.26.1"]
    repository = repository_in_project
...
def test_e2e_files(
    ...
    properties = {"key": "value"}
    full_code_dir = given_full_path_to_file(file_name="../../../tests/frogml/files")
    repository = repository_in_project
    expected_runtime_version = given_runtime_version
