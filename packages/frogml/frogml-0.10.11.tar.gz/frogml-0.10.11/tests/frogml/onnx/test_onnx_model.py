...
@patch("shutil.rmtree")
def test_log_model(
    mock_shutil_rmtree, mock_frog_ml, jf_project: str, frogml_services_mock: FrogmlMocks
):
    # Given
    ...
    code_dir = "../../../tests/frogml/onnx"
    model_dir = "../../../tests/resources/models/onnx"
    full_code_dir = given_full_path_to_file(file_name=code_dir)
