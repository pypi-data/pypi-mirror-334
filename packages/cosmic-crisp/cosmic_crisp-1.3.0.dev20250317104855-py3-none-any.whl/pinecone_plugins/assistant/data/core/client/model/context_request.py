...
class ContextRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'top_k': (int,),  # noqa: E501
            'max_context_tokens': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'max_context_tokens': 'max_context_tokens',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            max_context_tokens (int): The limit on the context tokens returned. The minimum size of a snippet is 500 tokens, so the minimum value for max_context_tokens is top_k * 500. The default context size is 20000 tokens. [optional]  # noqa: E501
        """
