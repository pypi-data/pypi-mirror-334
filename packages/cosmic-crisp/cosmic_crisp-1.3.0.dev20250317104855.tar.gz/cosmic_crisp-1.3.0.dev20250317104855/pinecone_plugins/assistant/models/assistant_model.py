...
class AssistantModel:
    ...
    def context(
        ...
        :param max_context_tokens: Optional integer to specify the limit on the context tokens returned. The minimum size of a snippet is 500 tokens, so the minimum value for max_context_tokens is top_k * 500. The default context size is 20000 tokens.
        :type max_context_tokens: Optional[int] (default None)
