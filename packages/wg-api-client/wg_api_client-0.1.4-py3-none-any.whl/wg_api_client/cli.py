...
def parse_args():
    ...
    config_parser.add_argument(
        "--role", choices=["drone", "fmo"], default="drone", help="Device role"
    )
    config_parser.add_argument(
...
def main():
    ...
    if args.command == "auth":
        ...
        success, data = api.request_wireguard_config(
            device_id, args.role, public_key
        )
        ...
        if success:
            ...
            success, message = WireGuardHelper.create_client_config(data, args.output)
            print(message)
