...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/treaty/{congress}/{treaty_number}/actions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Returns the list of actions on a specified treaty.
            ...
            \"actions\": [
                {
                    ...
                    \"committee\": null,
                    \"text\": \"Resolution of advice and consent to ratification agreed to as amended in
