...
def sync_detailed(
    *,
    ...
    r"""Returns a list of summaries sorted by date of last update.

     GET /summaries

    **Example Request**

    https://api.congress.gov/v3/summaries?fromDateTime=2022-04-01T00:00:00Z&toDateTime=2022-04-
    03T00:00:00Z&sort=updateDate+asc
