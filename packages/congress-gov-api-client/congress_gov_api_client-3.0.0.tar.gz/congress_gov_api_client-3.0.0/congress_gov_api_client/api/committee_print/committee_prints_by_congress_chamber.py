...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/committee-print/{congress}/{chamber}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Returns a list of committee prints filtered by the specified congress and chamber.
    ...
    **Example Response**
    ...
    print/117/house/48144?format=json\"
                  },
                  {
                      \"chamber\": \"House\",
                      \"congress\": 117,
                      ...
                      \"url\": \"https://api.congress.gov/v3/committee-
    print/117/house/48031?format=json\"
                  },
              ]
          }
