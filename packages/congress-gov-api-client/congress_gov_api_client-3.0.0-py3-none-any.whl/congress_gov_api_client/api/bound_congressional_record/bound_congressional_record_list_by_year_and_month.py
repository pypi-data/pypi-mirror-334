...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/bound-congressional-record/{year}/{month}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Returns a list of bound Congressional Records filtered by the specified year and specified month.
