...
def get_logger(fpath=None, fmode='w', logname=None,
               level=None, screen_show=True, show_loginfo=True):
    '''
    ...
    formatter_ = formatter if show_loginfo else formatter_none
    ...
    if fpath is not None:
        ...
        file_logger.setFormatter(formatter_ )
    ...
    if screen_show:
        ...
        console_logger.setFormatter(formatter_)
