...
setup(
    ...
    data_files=[
        ...
        ('tea2adt', ['tea2adt_source/killtea2adt.sh', 'tea2adt_source/mmack.sh', 'tea2adt_source/mmdata.sh', 'tea2adt_source/mmrx.sh', 'tea2adt_source/mmrxnopwd.sh', 'tea2adt_source/mmsessionout.sh', 'tea2adt_source/mmtx.sh', 'tea2adt_source/mmtxfile.sh', 'tea2adt_source/install_dependencies.sh', 'tea2adt_source/mute_mic.sh', 'tea2adt_source/restore_mic.sh', 'tea2adt_source/version', 'tea2adt_source/stt.sh', 'tea2adt_source/tts.sh']),
