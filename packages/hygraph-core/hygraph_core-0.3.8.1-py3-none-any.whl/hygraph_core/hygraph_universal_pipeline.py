...
class HyGraphUniversalPipeline:
    ...
    def configure_for_csv(
        ...
        nodes_folder: str,
        edges_folder: str,
        membership_node_file: str = None,
        membership_edge_file: str = None,
        ...
        self.loader = HyGraphCSVLoader(
           ...
           # edges_membership_path=membership_node_file,
           # nodes_membership_path=membership_edge_file,
