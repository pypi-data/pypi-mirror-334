...
class HardwarePoolIntegration:
    ...
    def _load_hw_profile(self) -> Dict:
        ...
        from lumino.contracts_client.utils import load_json_file
        ...
        profile = load_json_file(self.hw_profile_path, default_profile)
    ...
    def _save_hw_profile(self) -> None:
        ...
        from lumino.contracts_client.utils import save_json_file

        save_json_file(self.hw_profile_path, self.hw_profile)
