...
def load_contract_artifacts() -> Tuple[Dict[str, ChecksumAddress], str]:
    # Load contract addresses
    if os.path.isfile('./addresses.json'):
        addresses_path = './addresses.json'
    else:
        addresses_path = os.path.expanduser('~/.lumino/addresses.json')
    ...
    # Load contract ABIs
    abis_dir = os.path.expanduser(os.getenv('CC_ABIS_DIR', '~/.lumino/abis'))
