...
def fast_com2(verbose=False, maxtime=15, ping_count=5, forceipv4=False, forceipv6=False,
    ...
    result = (
        f"Download: {round(dl_speed_loaded,2)}\n"
        f"Upload: {round(upload_speed_dynamic,2)}\n"
...
def main():
    ...
    print("Download test results: {},{}".format(round(dl_speed_loaded,2), round(avg_ping_loaded)))
    ...
    print("Upload test result: {},,".format(round(upload_speed_dynamic,2)))
