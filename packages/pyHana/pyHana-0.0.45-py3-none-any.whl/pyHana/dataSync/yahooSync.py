...
def SyncStockTradeInfoUSA(shCode='', sDate='20140101', eDate='99991231', truncInd='N', splitAdjInd = False):
    SyncEtfTradeInfoUSA(shCode=shCode, sDate=sDate, eDate=eDate, truncInd=truncInd, gb='STOCK', splitAdjInd=splitAdjInd)

def SyncEtfTradeInfoUSA(shCode='', sDate='20140101', eDate='99991231', truncInd='N', gb='ETF', splitAdjInd = False):
    ''' 
    **kwargs
