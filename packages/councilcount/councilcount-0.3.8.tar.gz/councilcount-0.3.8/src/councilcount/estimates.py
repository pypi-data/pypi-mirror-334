...
def available_years():
    ...
    """
    Prints the available input years for all package functions with year variables.
    ...
    print(f"\nNote: when pulling results for an 5-Year ACS survey, only include the end year as the input for the year variable (e.g. '2023' for the 2019-2023 survey).")
...
def get_bbl_population_estimates(year=None):
    ...
    # construct the name of the dataset based on the year
    bbl_name = f"bbl-population-estimates_{year}.geojson"
