...
class AutotuneOptions final :
 ...
 public:
  ...
  private:
  bool _internal_has_min_parallelism() const;
  public:
...
inline void AutotuneOptions::clear_min_parallelism() {
  if (_internal_has_min_parallelism()) {
...
inline void AutotuneOptions::_internal_set_min_parallelism(int64_t value) {
  if (!_internal_has_min_parallelism()) {
...
inline void AutotuneOptions::set_min_parallelism(int64_t value) {
  _internal_set_min_parallelism(value);
